...
namespace TraktNET.CalendarsModule
{
    public sealed class GetAllNewShowsTests
    {
        ...
        [Theory]
        [InlineData(null, null, null, GetAllNewShowsUri, "Calendars\\calendarshows_minimal.json")]
        [InlineData("2011-04-18", null, null, "calendars/all/shows/new/2011-04-18", "Calendars\\calendarshows_minimal.json")]
        [InlineData(null, 7U, null, "calendars/all/shows/new/7", "Calendars\\calendarshows_minimal.json")]
        [InlineData("2011-04-18", 7U, null, "calendars/all/shows/new/2011-04-18/7", "Calendars\\calendarshows_minimal.json")]
        [InlineData(null, null, TraktExtendedInfo.Full, "calendars/all/shows/new?extended=full", "Calendars\\calendarshows.json")]
        [InlineData("2011-04-18", 7U, TraktExtendedInfo.Full, "calendars/all/shows/new/2011-04-18/7?extended=full", "Calendars\\calendarshows.json")]
        ...
        {
            TraktClient client = ModuleTestUtility.GetClient(GetAllNewShowsUri, statusCode);

            try
            {
                await client.Calendar.GetAllNewShowsAsync(cancellationToken: TestContext.Current.CancellationToken);
                Assert.False(true);
            }
