...
namespace TraktNET.CalendarsModule
{
    public sealed class GetAllShowsTests
    {
        ...
        [Theory]
        [InlineData(null, null, null, GetAllShowsUri, "Calendars\\calendarshows_minimal.json")]
        [InlineData("2011-04-18", null, null, "calendars/all/shows/2011-04-18", "Calendars\\calendarshows_minimal.json")]
        [InlineData(null, 7U, null, "calendars/all/shows/7", "Calendars\\calendarshows_minimal.json")]
        [InlineData("2011-04-18", 7U, null, "calendars/all/shows/2011-04-18/7", "Calendars\\calendarshows_minimal.json")]
        [InlineData(null, null, TraktExtendedInfo.Full, "calendars/all/shows?extended=full", "Calendars\\calendarshows.json")]
        [InlineData("2011-04-18", 7U, TraktExtendedInfo.Full, "calendars/all/shows/2011-04-18/7?extended=full", "Calendars\\calendarshows.json")]
        ...
        {
            TraktClient client = ModuleTestUtility.GetClient(GetAllShowsUri, statusCode);

            try
            {
                await client.Calendar.GetAllShowsAsync(cancellationToken: TestContext.Current.CancellationToken);
                Assert.False(true);
            }
