...
namespace TraktNET.CommentsModule
{
    public sealed class PostEpisodeCommentReplyTests
    {
        ...
        private static readonly string PostEpisodeCommentUri = $"comments";
        ...
        [Fact]
        public async Task TestTraktCommentsModulePostEpisodeComment()
        {
        ...
        public async Task TestTraktCommentsModulPostEpisodeCommentThrowsAPIException(HttpStatusCode statusCode, Type exceptionType)
        {
