...
namespace TraktNET.UsersModule
{
    public sealed class GetCollectionShowsTests
    {
        ...
        public async Task TestGetCollectionShows()
        {
            ...
            TraktClient client = ModuleTestUtility.GetClient(GET_COLLECTION_SHOWS_URI, responseContent);
        ...
        public async Task TestGetCollectionShowsWithOAuthEnforced()
        {
            ...
            TraktClient client = ModuleTestUtility.GetOAuthClient(GET_COLLECTION_SHOWS_URI, responseContent);
        ...
        public async Task TestGetCollectionShowsWithExtendedInfo()
        {
            ...
            TraktClient client = ModuleTestUtility.GetClient($"{GET_COLLECTION_SHOWS_URI}?extended={ExtendedInfo.ToURI()}", responseContent);
        ...
        {
            TraktClient client = ModuleTestUtility.GetClient(GET_COLLECTION_SHOWS_URI, statusCode);
