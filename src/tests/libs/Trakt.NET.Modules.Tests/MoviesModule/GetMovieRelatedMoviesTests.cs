...
namespace TraktNET.MoviesModule
{
    public sealed class GetMovieRelatedMoviesTests
    {
        ...
        private static readonly string GetMovieRelatedMoviesUri = $"{GetMovieRelatedMoviesUriPrefix}/{TestConstants.Movies.TraktMovieID}/{GetMovieRelatedMoviesUriSuffix}";
        ...
        public async Task TestGetMovieRelatedMoviesWithID(TraktExtendedInfo? extendedInfo, uint? page, uint? limit, string requestUri, string responseContentFile)
        {
            ...
            TraktPagedResponse<TraktMovie> response = await client.Movies.GetMovieRelatedMoviesAsync(TestConstants.Movies.TraktMovieID, extendedInfo, page, limit, TestContext.Current.CancellationToken);
        ...
        public async Task TestGetMovieRelatedMoviesWithSlug(TraktExtendedInfo? extendedInfo, uint? page, uint? limit, string requestUri, string responseContentFile)
        {
            ...
            TraktPagedResponse<TraktMovie> response = await client.Movies.GetMovieRelatedMoviesAsync(TestConstants.Movies.MovieSlug, extendedInfo, page, limit, TestContext.Current.CancellationToken);
        ...
        public async Task TestGetMovieRelatedMoviesWithIDs(TraktExtendedInfo? extendedInfo, uint? page, uint? limit, string requestUri, string responseContentFile)
        {
            ...
            TraktPagedResponse<TraktMovie> response = await client.Movies.GetMovieRelatedMoviesAsync(TestConstants.Movies.MovieIDs, extendedInfo, page, limit, TestContext.Current.CancellationToken);
        ...
        public async Task TestGetMovieRelatedMoviesWithIDPagingHasPreviousPage()
        {
            ...
            TraktPagedResponse<TraktMovie> response = await client.Movies.GetMovieRelatedMoviesAsync(TestConstants.Movies.TraktMovieID, page: 2, cancellationToken: TestContext.Current.CancellationToken);
        ...
        public async Task TestGetMovieRelatedMoviesWithIDPagingHasNextPage()
        {
            ...
            TraktPagedResponse<TraktMovie> response = await client.Movies.GetMovieRelatedMoviesAsync(TestConstants.Movies.TraktMovieID, page: 1, cancellationToken: TestContext.Current.CancellationToken);
        ...
        public async Task TestGetMovieRelatedMoviesWithSlugPagingHasPreviousPage()
        {
            ...
            TraktPagedResponse<TraktMovie> response = await client.Movies.GetMovieRelatedMoviesAsync(TestConstants.Movies.MovieSlug, page: 2, cancellationToken: TestContext.Current.CancellationToken);
        ...
        public async Task TestGetMovieRelatedMoviesWithSlugPagingHasNextPage()
        {
            ...
            TraktPagedResponse<TraktMovie> response = await client.Movies.GetMovieRelatedMoviesAsync(TestConstants.Movies.MovieSlug, page: 1, cancellationToken: TestContext.Current.CancellationToken);
        ...
        public async Task TestGetMovieRelatedMoviesWithIDsPagingHasPreviousPage()
        {
            ...
            TraktPagedResponse<TraktMovie> response = await client.Movies.GetMovieRelatedMoviesAsync(TestConstants.Movies.MovieIDs, page: 2, cancellationToken: TestContext.Current.CancellationToken);
        ...
        public async Task TestGetMovieRelatedMoviesWithIDsPagingHasNextPage()
        {
            ...
            TraktPagedResponse<TraktMovie> response = await client.Movies.GetMovieRelatedMoviesAsync(TestConstants.Movies.MovieIDs, page: 1, cancellationToken: TestContext.Current.CancellationToken);
        ...
        public async Task TestGetMovieRelatedMoviesWithIDThrowsApiException(HttpStatusCode statusCode, Type exceptionType)
        {
            ...
            try
            {
                await client.Movies.GetMovieRelatedMoviesAsync(TestConstants.Movies.TraktMovieID, cancellationToken: TestContext.Current.CancellationToken);
                Assert.False(true);
            }
        ...
        public async Task TestGetMovieRelatedMoviesWithSlugThrowsApiException(HttpStatusCode statusCode, Type exceptionType)
        {
            ...
            try
            {
                await client.Movies.GetMovieRelatedMoviesAsync(TestConstants.Movies.MovieSlug, cancellationToken: TestContext.Current.CancellationToken);
                Assert.False(true);
            }
            catch (Exception exception)
            {
        ...
        public async Task TestGetMovieRelatedMoviesWithIDsThrowsApiException(HttpStatusCode statusCode, Type exceptionType)
        {
            ...
            try
            {
                await client.Movies.GetMovieRelatedMoviesAsync(TestConstants.Movies.MovieIDs, cancellationToken: TestContext.Current.CancellationToken);
                Assert.False(true);
            }
            catch (Exception exception)
            {
...
#pragma warning disable CS8625 // Cannot convert null literal to non-nullable reference type.
            Func<Task<TraktPagedResponse<TraktMovie>>> act = () => client.Movies.GetMovieRelatedMoviesAsync(default(TraktMovieIDs), cancellationToken: TestContext.Current.CancellationToken);
#pragma warning restore CS8625 // Cannot convert null literal to non-nullable reference type.
            await act.ShouldThrowAsync<ArgumentException>();

            var movieIDs = new TraktMovieIDs();

            act = () => client.Movies.GetMovieRelatedMoviesAsync(movieIDs, cancellationToken: TestContext.Current.CancellationToken);
            await act.ShouldThrowAsync<ArgumentException>();
        }
    }
}
