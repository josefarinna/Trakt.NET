...
namespace TraktNET.MoviesModule
{
    public sealed class GetTrendingMoviesTests
    {
        ...
        public async Task TestGetTrendingMoviesPagingHasPreviousPage()
        {
            ...
            TraktPagedResponse<TraktTrendingMovie> response = await client.Movies.GetTrendingMoviesAsync(2);
        ...
        public async Task TestGetTrendingMoviesPagingHasNextPage()
        {
            ...
            TraktPagedResponse<TraktTrendingMovie> response = await client.Movies.GetTrendingMoviesAsync(1);
