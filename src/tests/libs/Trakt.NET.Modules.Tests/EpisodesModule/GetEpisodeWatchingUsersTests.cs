...
namespace TraktNET.EpisodesModule
{
    public sealed class GetEpisodeWatchingUsersTests
    {
        ...
        public async Task TestGetEpisodeWatchingUsersWithTraktID()
        {
            ...
            TraktListResponse<TraktUser> response = await client.Episodes.GetEpisodeWatchingUsersAsync(TestConstants.Shows.TraktShowID, SeasonNr, EpisodeNr, cancellationToken: TestContext.Current.CancellationToken);
        ...
        public async Task TestGetEpisodeWatchingUsersWithShowIdsSlug()
        {
            ...
            TraktClient client = ModuleTestUtility.GetClient($"shows/{TestConstants.Shows.ShowSlug}/seasons/{SeasonNr}/episodes/{EpisodeNr}/watching", responseContent);
        ...
        public async Task TestGetEpisodeWatchingUsersWithShowIds()
        {
            ...
            TraktListResponse<TraktUser> response = await client.Episodes.GetEpisodeWatchingUsersAsync(TestConstants.Shows.ShowIDs, SeasonNr, EpisodeNr, cancellationToken: TestContext.Current.CancellationToken);
        ...
        public async Task TestGetEpisodeWatchingUsersWithExtendedInfo()
        {
            ...
            TraktClient client = ModuleTestUtility.GetClient($"{GetEpisodeWatchingUsersUri}?extended={ExtendedInfo.ToURI()}", responseContent);

            TraktListResponse<TraktUser> response = await client.Episodes.GetEpisodeWatchingUsersAsync(TestConstants.Shows.ShowID, SeasonNr, EpisodeNr, ExtendedInfo, TestContext.Current.CancellationToken);
        ...
        public async Task TestGetEpisodeWatchingUsersThrowsAPIException(HttpStatusCode statusCode, Type exceptionType)
        {
            ...
            Func<Task<TraktListResponse<TraktUser>>> act = () => client.Episodes.GetEpisodeWatchingUsersAsync(TestConstants.Shows.ShowID, SeasonNr, EpisodeNr, cancellationToken: TestContext.Current.CancellationToken);
