...
namespace TraktNET.EpisodesModule
{
    public sealed class GetEpisodeTests
    {
        ...
        public async Task TestGetEpisodeWithExtendedInfo()
        {
            ...
            TraktResponse<TraktEpisode> response = await client.Episodes.GetEpisodeAsync(ShowID, SeasonNr, EpisodeNr, ExtendedInfo, TestContext.Current.CancellationToken);
        ...
        public async Task TestGetEpisodeThrowsAPIException(HttpStatusCode statusCode, Type exceptionType)
        {
            ...
            Func<Task<TraktResponse<TraktEpisode>>> act = () => client.Episodes.GetEpisodeAsync(ShowID, SeasonNr, EpisodeNr, cancellationToken: TestContext.Current.CancellationToken);
