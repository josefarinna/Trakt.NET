...
namespace TraktNET.SyncModule
{
    public sealed class GetWatchedShowsTests
    {
        ...
        public async Task TestGetWatchedShows()
        {
            ...
            TraktPagedResponse<TraktWatchedShow> response = await client.Sync.GetWatchedShowsAsync(null, Page, Limit, TestContext.Current.CancellationToken);
        ...
        public async Task TestGetWatchedShowsWithExtendedInfo()
        {
            ...
            TraktClient client = ModuleTestUtility.GetOAuthClient($"{GetWatchedShowsUri}?extended={ExtendedInfo.ToURI()}&page={Page}&limit={Limit}", responseContent, Page, 1, Limit, ShowsCount);
            TraktPagedResponse<TraktWatchedShow> response = await client.Sync.GetWatchedShowsAsync(ExtendedInfo, Page, Limit, TestContext.Current.CancellationToken);
        ...
        public async Task TestGetWatchedShowsPagingHasPreviousPageAndHasNextPage()
        {
            ...
            TraktPagedResponse<TraktWatchedShow> response =
                await client.Sync.GetWatchedShowsAsync(ExtendedInfo, 2, Limit, TestContext.Current.CancellationToken);
        ...
        public async Task TestGetWatchedShowsPagingOnlyHasNextPage()
        {
            ...
            TraktPagedResponse<TraktWatchedShow> response =
                await client.Sync.GetWatchedShowsAsync(ExtendedInfo, 1, Limit, TestContext.Current.CancellationToken);
        ...
        {
            TraktClient client = ModuleTestUtility.GetOAuthClient($"{GetWatchedShowsUri}?page={Page}&limit={Limit}", statusCode);

            Func<Task<TraktPagedResponse<TraktWatchedShow>>> act = () => client.Sync.GetWatchedShowsAsync(null, Page, Limit, TestContext.Current.CancellationToken);
        ...
        {
            TraktClient client = ModuleTestUtility.GetOAuthClient($"{GetWatchedShowsUri}?page={Page}&limit={Limit}", HttpStatusCode.OK);

            Func<Task<TraktPagedResponse<TraktWatchedShow>>> act = () => client.Sync.GetWatchedShowsAsync(null, null, 10, TestContext.Current.CancellationToken);
            await act.ShouldThrowAsync<ArgumentNullException>();

            act = () => client.Sync.GetWatchedShowsAsync(null, 1, null, TestContext.Current.CancellationToken);
            await act.ShouldThrowAsync<ArgumentNullException>();
        }
    }
}
