...
{
    public sealed class TraktPersonMovieCreditsTests
    {
        [Fact]
        ...
        [Fact]
        public async Task TestTraktPersonMovieCreditsFromJson()
        {
            TraktPersonMovieCredits? credits = await TestUtility.DeserializeJsonAsync<TraktPersonMovieCredits>("People\\personmoviecredits.json");
            ...
            TraktPersonMovieCreditsCastItem[] creditsCast = [.. credits.Cast];

            creditsCast[0].ShouldNotBeNull();
            creditsCast[0].Characters.ShouldNotBeNull();
            creditsCast[0].Characters!.Count.ShouldBe(1);
            creditsCast[0].Characters!.ShouldContain("Rey");
            creditsCast[0].Movie.ShouldNotBeNull();
            creditsCast[0].Movie!.Title.ShouldBe("Star Wars: The Force Awakens");
            creditsCast[0].Movie!.Year.ShouldBe(2015U);
            creditsCast[0].Movie!.IDs.ShouldNotBeNull();
            creditsCast[0].Movie!.IDs!.Trakt.ShouldBe(94024U);
            creditsCast[0].Movie!.IDs!.Slug.ShouldBe("star-wars-the-force-awakens-2015");
            creditsCast[0].Movie!.IDs!.IMDB.ShouldBe("tt2488496");
            creditsCast[0].Movie!.IDs!.TMDB.ShouldBe(140607U);
            creditsCast[0].Movie!.Tagline.ShouldBeNullOrEmpty();
            creditsCast[0].Movie!.Overview.ShouldBeNullOrEmpty();
            creditsCast[0].Movie!.Released.ShouldBeNull();
            creditsCast[0].Movie!.Runtime.ShouldBeNull();
            creditsCast[0].Movie!.UpdatedAt.ShouldBeNull();
            creditsCast[0].Movie!.Trailer.ShouldBeNullOrEmpty();
            creditsCast[0].Movie!.Homepage.ShouldBeNullOrEmpty();
            creditsCast[0].Movie!.Rating.ShouldBeNull();
            creditsCast[0].Movie!.Votes.ShouldBeNull();
            creditsCast[0].Movie!.Language.ShouldBeNullOrEmpty();
            creditsCast[0].Movie!.AvailableTranslations.ShouldBeNull();
            creditsCast[0].Movie!.Genres.ShouldBeNull();
            creditsCast[0].Movie!.Certification.ShouldBeNullOrEmpty();

            creditsCast[1].ShouldNotBeNull();
            creditsCast[1].Characters.ShouldNotBeNull();
            creditsCast[1].Characters!.Count.ShouldBe(1);
            creditsCast[1].Characters!.ShouldContain("Han Solo");
            creditsCast[1].Movie.ShouldNotBeNull();
            creditsCast[1].Movie!.Title.ShouldBe("Star Wars: The Force Awakens");
            creditsCast[1].Movie!.Year.ShouldBe(2015U);
            creditsCast[1].Movie!.IDs.ShouldNotBeNull();
            creditsCast[1].Movie!.IDs!.Trakt.ShouldBe(94024U);
            creditsCast[1].Movie!.IDs!.Slug.ShouldBe("star-wars-the-force-awakens-2015");
            creditsCast[1].Movie!.IDs!.IMDB.ShouldBe("tt2488496");
            creditsCast[1].Movie!.IDs!.TMDB.ShouldBe(140607U);
            creditsCast[1].Movie!.Tagline.ShouldBeNullOrEmpty();
            creditsCast[1].Movie!.Overview.ShouldBeNullOrEmpty();
            creditsCast[1].Movie!.Released.ShouldBeNull();
            creditsCast[1].Movie!.Runtime.ShouldBeNull();
            creditsCast[1].Movie!.UpdatedAt.ShouldBeNull();
            creditsCast[1].Movie!.Trailer.ShouldBeNullOrEmpty();
            creditsCast[1].Movie!.Homepage.ShouldBeNullOrEmpty();
            creditsCast[1].Movie!.Rating.ShouldBeNull();
            creditsCast[1].Movie!.Votes.ShouldBeNull();
            creditsCast[1].Movie!.Language.ShouldBeNullOrEmpty();
            creditsCast[1].Movie!.AvailableTranslations.ShouldBeNull();
            creditsCast[1].Movie!.Genres.ShouldBeNull();
            creditsCast[1].Movie!.Certification.ShouldBeNullOrEmpty();

            TraktPersonMovieCreditsCrew creditsCrew = credits.Crew;
