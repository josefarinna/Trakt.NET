...
{
    public sealed class MostFavoritedShowsGetRequestTests
    {
        private const string URIPath = $"shows/favorited";
        ...
        public void TestMostFavoritedShowsGetRequestHasValidURIPath(TraktTimePeriod? timePeriod, TraktExtendedInfo? extendedInfo,
