...
namespace TraktNET.GetRequests.Movies
{
    public sealed class MovieStatisticsGetRequestTests
    {
        ...
        public void TestMovieStatisticsGetRequestHasValidURIPath()
        {
            ...
            movieStatisticsGetRequest.RequestUri.ShouldBe(new Uri(URIPath, UriKind.Relative));
        }
        ...
        {
            var movieStatisticsGetRequest = new MovieStatisticsGetRequest { Id = MovieID };
            movieStatisticsGetRequest.OAuthRequirement.ShouldBe(TraktOAuthRequirement.NotRequired);
        }
        ...
        {
            var movieStatisticsGetRequest = new MovieStatisticsGetRequest { Id = MovieID };
            movieStatisticsGetRequest.Method.ShouldBe(HttpMethod.Get);
        }
        ...
        {
            var movieStatisticsGetRequest = new MovieStatisticsGetRequest { Id = MovieID };
            movieStatisticsGetRequest.RequestObjectType.ShouldBe(TraktRequestObjectType.Movie);
        }
