...
{
    public sealed class CommentsTrendingGetRequestTests
    {
        private const string URIPath = "comments/trending";
        ...
        public void TestCommentsTrendingGetRequestHasValidURIPath(TraktCommentObjectType? type, TraktExtendedInfo? extendedInfo, int? page, int? limit, string expectedURIPath)
        {
            var commentsTrendingGetRequest = new CommentsTrendingGetRequest
            {
                Type = type,
            ...
            commentsTrendingGetRequest.BuildUri();
            commentsTrendingGetRequest.RequestUri.ShouldBe(new Uri(expectedURIPath, UriKind.Relative));
        }

        [Fact]
        public void TestCommentsTrendingGetRequestHasValidOAuthRequirement()
        {
            var commentsTrendingGetRequest = new CommentsTrendingGetRequest();
            commentsTrendingGetRequest.OAuthRequirement.ShouldBe(TraktOAuthRequirement.NotRequired);
        }

        [Fact]
        public void TestCommentsTrendingGetRequestIsGetRequest()
        {
            var commentsTrendingGetRequest = new CommentsTrendingGetRequest();
            commentsTrendingGetRequest.Method.ShouldBe(HttpMethod.Get);
        }

        [Fact]
        public void TestCommentsTrendingGetRequestHasCorrectRequestObjectType()
        {
            var commentsTrendingGetRequest = new CommentsTrendingGetRequest();
            commentsTrendingGetRequest.RequestObjectType.ShouldBe(TraktRequestObjectType.Comment);
        }
    }
}
