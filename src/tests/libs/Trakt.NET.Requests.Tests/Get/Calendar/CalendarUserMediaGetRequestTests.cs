...
namespace TraktNET.GetRequests.Calendar
{
    public sealed class CalendarUserMediaGetRequestTests
    {
        ...
        public void TestCalendarUserMediaGetRequestHasValidURIPath(TraktExtendedInfo? extendedInfo, TraktCalendarMediaType? type, TraktCalendarGroup? group, string expectedURIPath)
        {
