...
namespace TraktNET.GetRequests.Calendar
{
    public sealed class CalendarAllSeasonPremieresGetRequestTests
    {
        ...
        [Fact]
        public void TestCalendarAllSeasonPremieresGetRequestHasValidURIPathWithFilter()
        {
            ...
            calendarAllSeasonPremieresGetRequest.BuildUri();
            calendarAllSeasonPremieresGetRequest.RequestUri.ShouldBe(new Uri(URIPath + "/" + StartDateURIValue + "/7?query=game of thrones", UriKind.Relative));
        }
    }
}
