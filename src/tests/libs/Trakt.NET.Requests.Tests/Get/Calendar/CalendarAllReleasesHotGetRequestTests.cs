...
{
    public sealed class CalendarAllReleasesHotGetRequestTests
    {
        private const string URIPath = "calendars/releases/hot";
        ...
        [Fact]
        public void TestCalendarAllReleasesHotGetRequestHasValidOAuthRequirement()
        {
            var request = new CalendarAllReleasesHotGetRequest
            {
                StartDate = StartDateURIValue,
        ...
        [Fact]
        public void TestCalendarAllReleasesHotGetRequestIsGetRequest()
        {
            var request = new CalendarAllReleasesHotGetRequest
            {
                StartDate = StartDateURIValue,
        ...
        [Fact]
        public void TestCalendarAllReleasesHotGetRequestHasCorrectRequestObjectType()
        {
            var request = new CalendarAllReleasesHotGetRequest
            {
                StartDate = StartDateURIValue,
        ...
        [Fact]
        public void TestCalendarAllReleasesHotGetRequestHasValidURIPathWithFilter()
        {
