namespace TraktNET
{
    ...
    public record class TraktShowTranslation
    {
        /// <summary>The translated title of a show.</summary>
        public string? Title { get; set; }

        /// <summary>The translated synopsis of a show.</summary>
        public string? Overview { get; set; }

        /// <summary>The translated tagline of a show.</summary>
