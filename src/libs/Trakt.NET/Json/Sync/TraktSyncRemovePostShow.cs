...
{
    /// <summary>
    /// A Trakt sync post show, containing the required show ids.
    /// <para>Can also contain optional seasons.</para>
    /// </summary>
    public record class TraktSyncRemovePostShow
    {
        ...
        /// <summary>
        /// An optional list of <see cref="TraktSyncRemovePostShowSeason" />s.
        /// <para>
        ...
        /// </para>
        /// </summary>
        public List<TraktSyncRemovePostShowSeason>? Seasons { get; set; }
    }
}
