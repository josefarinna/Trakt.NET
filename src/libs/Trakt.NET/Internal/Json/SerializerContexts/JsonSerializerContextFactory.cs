...
namespace TraktNET
{
    internal static class JsonSerializerContextFactory
    {
        ...
        private static readonly FrozenSet<Type> s_syncsJsonTypes = FrozenSet.ToFrozenSet(new[]
        {
            ...
            typeof(TraktSyncCollectionEpisode),
            typeof(TraktSyncCollectionMedia),
            typeof(TraktSyncCollectionAvailableOn),
        ...
        private static readonly FrozenSet<Type> s_usersJsonTypes = FrozenSet.ToFrozenSet(new[]
        {
            ...
            typeof(TraktUserSavedFilterPostResponse),
            ...
            typeof(Dictionary<string, Dictionary<string, Dictionary<string, List<string>>>>)
        });
