namespace TraktNET
{
    public sealed partial class TraktMoviesModule
    {
        ...
        public Task<TraktResponse> RefreshMovieAsync(string traktMovieIDOrSlug, CancellationToken cancellationToken = default)
            => RefreshMovieAsync(traktMovieIDOrSlug, null, cancellationToken);
        ...
        /// <exception cref="TraktApiException">Thrown if the request fails.</exception>
        /// <exception cref="TraktRequestValidationException">Thrown if the validation (e.g. invalid id) of the request fails.</exception>
        public Task<TraktResponse> RefreshMovieAsync(string traktMovieIDOrSlug, bool? images, CancellationToken cancellationToken = default)
            => RefreshMovieImplAsync(traktMovieIDOrSlug, images, cancellationToken);
        ...
        public Task<TraktResponse> RefreshMovieAsync(uint traktMovieID, CancellationToken cancellationToken = default)
            => RefreshMovieAsync(traktMovieID, null, cancellationToken);
        ...
        /// <exception cref="TraktRequestValidationException">Thrown if the validation (e.g. invalid id) of the request fails.</exception>
        /// <exception cref="ArgumentException">Thrown, if the given <paramref name="traktMovieID"/> is 0.</exception>
        public Task<TraktResponse> RefreshMovieAsync(uint traktMovieID, bool? images, CancellationToken cancellationToken = default)
        {
            if (traktMovieID == 0)
                throw new ArgumentException("movie id must not be 0", nameof(traktMovieID));

            return RefreshMovieAsync(traktMovieID.ToInvariantCultureString(), images, cancellationToken);
        }
        ...
        public Task<TraktResponse> RefreshMovieAsync(TraktMovieIDs movieIDs, CancellationToken cancellationToken = default)
            => RefreshMovieAsync(movieIDs, null, cancellationToken);
        ...
        /// <exception cref="ArgumentException">Throw if the given <paramref name="movieIDs" /> has not set any IDs.</exception>
        /// <exception cref="ArgumentNullException">Thrown if the given <paramref name="movieIDs" /> is null.</exception>
        public Task<TraktResponse> RefreshMovieAsync(TraktMovieIDs movieIDs, bool? images, CancellationToken cancellationToken = default)
        {
            ...
            return RefreshMovieImplAsync(movieIDs.BestID, images, cancellationToken);
        }
    }
}
