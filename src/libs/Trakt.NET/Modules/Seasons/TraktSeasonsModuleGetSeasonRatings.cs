namespace TraktNET
{
    public sealed partial class TraktSeasonsModule
    {
        ...
        /// Specifies how much data should be queried about the season ratings.
        ...
        public Task<TraktResponse<TraktRating>> GetSeasonRatingsAsync(string traktShowIDOrSlug, uint seasonNumber,
            ...
            => GetSeasonRatingsImplAsync(traktShowIDOrSlug, seasonNumber, extendedInfo, cancellationToken);
            ...
            TraktExtendedInfo? extendedInfo = null, CancellationToken cancellationToken = default)
        {
            ...
            return GetSeasonRatingsAsync(traktShowID.ToInvariantCultureString(), seasonNumber, extendedInfo, cancellationToken);
        }
            ...
            TraktExtendedInfo? extendedInfo = null, CancellationToken cancellationToken = default)
        {
            ...
            return GetSeasonRatingsAsync(showIDs.BestID, seasonNumber, extendedInfo, cancellationToken);
        }
            ...
            TraktExtendedInfo? extendedInfo = null, CancellationToken cancellationToken = default)
        {
            ...
            return GetSeasonRatingsAsync(show.IDs!, seasonNumber, extendedInfo, cancellationToken);
        }
    }
}
