namespace TraktNET
{
    public sealed partial class TraktSeasonsModule
    {
        ...
        public Task<TraktResponse<TraktRating>> GetSeasonRatingsAsync(uint traktShowID, uint seasonNumber,
            CancellationToken cancellationToken = default)
            => GetSeasonRatingsImplAsync(traktShowID.ToInvariantCultureString(), seasonNumber, cancellationToken);
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            return GetSeasonRatingsImplAsync(showIDs.BestID, seasonNumber, cancellationToken);
        }
    }
}
