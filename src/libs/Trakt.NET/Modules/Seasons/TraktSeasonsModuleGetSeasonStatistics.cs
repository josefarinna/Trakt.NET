namespace TraktNET
{
    ...
    {
        /// <summary>Gets the statistics for a specific <see cref="TraktShow" /> of a Trakt show with the specified Trakt-ID or -Slug.</summary>
        ...
        /// <para><see href="https://trakt.docs.apiary.io/#reference/seasons/stats/get-season-stats">
        ...
        /// <summary>Gets the statistics for a specific <see cref="TraktShow" /> of a Trakt show with the specified Trakt-ID.</summary>
        ...
        public Task<TraktResponse<TraktSeasonStatistics>> GetSeasonStatisticsAsync(uint traktShowID, uint seasonNumber,
            CancellationToken cancellationToken = default)
            => GetSeasonStatisticsImplAsync(traktShowID.ToInvariantCultureString(), seasonNumber, cancellationToken);

        /// <summary>Gets the statistics for a specific <see cref="TraktShow" /> of a Trakt show with the specified <see cref="TraktShowIDs" />.</summary>
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            return GetSeasonStatisticsImplAsync(showIDs.BestID, seasonNumber, cancellationToken);
        }
    }
}
