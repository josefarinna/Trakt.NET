namespace TraktNET
{
    public sealed partial class TraktSeasonsModule
    {
            ...
            TraktExtendedInfo? extendedInfo = null, CancellationToken cancellationToken = default)
        {
            ...
            return GetSeasonVideosAsync(traktShowID.ToInvariantCultureString(), seasonNumber, extendedInfo, cancellationToken);
        }
            ...
            TraktExtendedInfo? extendedInfo = null, CancellationToken cancellationToken = default)
        {
            ...
            return GetSeasonVideosAsync(showIDs.BestID, seasonNumber, extendedInfo, cancellationToken);
        }

        /// <summary>Gets all videos for a specific <see cref="TraktSeason" /> of a Trakt show with the specified <see cref="TraktShow" />.</summary>
        ...
        public Task<TraktListResponse<TraktVideo>> GetSeasonVideosAsync(TraktShow show, uint seasonNumber,
            TraktExtendedInfo? extendedInfo = null, CancellationToken cancellationToken = default)
        {
            ArgumentValidator.ThrowIfNull(show);

            return GetSeasonVideosAsync(show.IDs!, seasonNumber, extendedInfo, cancellationToken);
        }
    }
}
