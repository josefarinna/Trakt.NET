namespace TraktNET
{
    public sealed partial class TraktSeasonsModule
    {
            ...
            uint? page = null, uint? limit = null, CancellationToken cancellationToken = default)
        {
            ...
            return GetSeasonListsAsync(traktShowID.ToInvariantCultureString(), seasonNumber, listType, listSortOrder, extendedInfo, page, limit, cancellationToken);
        }
            ...
            uint? page = null, uint? limit = null, CancellationToken cancellationToken = default)
        {
            ...
            return GetSeasonListsAsync(showIDs.BestID, seasonNumber, listType, listSortOrder, extendedInfo, page, limit, cancellationToken);
        }

        /// <summary>Gets all lists containing a specific <see cref="TraktSeason" /> of a Trakt show with the specified <see cref="TraktShow" />.</summary>
        ...
        public Task<TraktPagedResponse<TraktList>> GetSeasonListsAsync(TraktShow show, uint seasonNumber,
            TraktListType? listType = null, TraktListSortOrder? listSortOrder = null, TraktExtendedInfo? extendedInfo = null,
            uint? page = null, uint? limit = null, CancellationToken cancellationToken = default)
        {
            ArgumentValidator.ThrowIfNull(show);

            return GetSeasonListsAsync(show.IDs!, seasonNumber, listType, listSortOrder, extendedInfo, page, limit, cancellationToken);
        }
    }
}
