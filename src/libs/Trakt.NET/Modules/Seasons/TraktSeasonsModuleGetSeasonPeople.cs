namespace TraktNET
{
    public sealed partial class TraktSeasonsModule
    {
        ...
        /// <para><see href="https://docs.trakt.tv/reference/getshowsseasonpeople">
            ...
            TraktExtendedInfo? extendedInfo = null, CancellationToken cancellationToken = default)
        {
            ...
            return GetSeasonPeopleAsync(traktShowID.ToInvariantCultureString(), seasonNumber, extendedInfo, cancellationToken);
        }
            ...
            TraktExtendedInfo? extendedInfo = null, CancellationToken cancellationToken = default)
        {
            ...
            return GetSeasonPeopleAsync(showIDs.BestID, seasonNumber, extendedInfo, cancellationToken);
        }

        /// <summary>Gets all people for a specific <see cref="TraktSeason" /> of a Trakt show with the specified <see cref="TraktShow" />.</summary>
        ...
        public Task<TraktResponse<TraktCastAndCrew>> GetSeasonPeopleAsync(TraktShow show, uint seasonNumber,
            TraktExtendedInfo? extendedInfo = null, CancellationToken cancellationToken = default)
        {
