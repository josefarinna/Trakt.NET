namespace TraktNET
{
    public sealed partial class TraktEpisodesModule
    {
        ...
        /// <para />
        /// See also <seealso cref="TraktResponse{TResponseContentType}" /> and <seealso cref="TraktRating" />.
        /// </returns>
        /// <remarks>
        ...
        public Task<TraktResponse<TraktRating>> GetEpisodeRatingsAsync(string showIdOrSlug, uint seasonNumber, uint episodeNumber,
            ...
            => GetEpisodeRatingsImplAsync(showIdOrSlug, seasonNumber, episodeNumber, cancellationToken);
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            return GetEpisodeRatingsAsync(traktShowID.ToInvariantCultureString(), seasonNumber, episodeNumber, cancellationToken);
        }
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            return GetEpisodeRatingsAsync(showIds.BestID, seasonNumber, episodeNumber, cancellationToken);
        }
