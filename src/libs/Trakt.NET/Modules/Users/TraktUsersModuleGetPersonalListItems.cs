namespace TraktNET
{
    public sealed partial class TraktUsersModule
    {
        ...
        public Task<TraktPagedResponse<TraktListItem>> GetPersonalListItemsAsync(string usernameOrSlug, string listIdOrSlug,
            ...
            => GetPersonalListItemsImplAsync(usernameOrSlug, listIdOrSlug, listItemType, filter, extendedInfo, page, limit, cancellationToken);
            ...
            uint? page = null, uint? limit = null, CancellationToken cancellationToken = default)
        {
            ...
            return GetPersonalListItemsAsync(usernameOrSlug, traktListId.ToInvariantCultureString(), listItemType, filter, extendedInfo, page, limit, cancellationToken);
        }
            ...
            uint? page = null, uint? limit = null, CancellationToken cancellationToken = default)
        {
            ...
            return GetPersonalListItemsAsync(usernameOrSlug, listIds.BestID, listItemType, filter, extendedInfo,
            ...
            uint? page = null, uint? limit = null, CancellationToken cancellationToken = default)
        {
            ...
            return GetPersonalListItemsAsync(usernameOrSlug, list.IDs!, listItemType, filter, extendedInfo,
                                             page, limit, cancellationToken);
        }
    }
}
