namespace TraktNET
{
    ...
    {
        /// <summary>Gets all lists containing a <see cref="TraktShow" /> with the specified Trakt-ID or -Slug.</summary>
        ...
        public Task<TraktPagedResponse<TraktList>> GetShowListsAsync(string traktShowIDOrSlug, TraktListType? listType = null,
            TraktListSortOrder? listSortOrder = null, TraktExtendedInfo? extendedInfo = null, uint? page = null, uint? limit = null,
            CancellationToken cancellationToken = default)
            => GetShowListsImplAsync(traktShowIDOrSlug, listType, listSortOrder, extendedInfo, page, limit, cancellationToken);

        /// <summary>Gets all lists containing a <see cref="TraktShow" /> with the specified Trakt-ID.</summary>
        ...
        /// <exception cref="TraktApiException">Thrown if the request fails.</exception>
        /// <exception cref="TraktRequestValidationException">Thrown if the validation (e.g. invalid id) of the request fails.</exception>
        public Task<TraktPagedResponse<TraktList>> GetShowListsAsync(uint traktShowID, TraktListType? listType = null,
            TraktListSortOrder? listSortOrder = null, TraktExtendedInfo? extendedInfo = null, uint? page = null, uint? limit = null,
            CancellationToken cancellationToken = default)
            => GetShowListsImplAsync(traktShowID.ToInvariantCultureString(), listType, listSortOrder, extendedInfo, page, limit, cancellationToken);

        /// <summary>Gets all lists containing a <see cref="TraktShow" /> with the specified <see cref="TraktShowIDs" />.</summary>
        ...
        public Task<TraktPagedResponse<TraktList>> GetShowListsAsync(TraktShowIDs showIDs, TraktListType? listType = null,
            TraktListSortOrder? listSortOrder = null, TraktExtendedInfo? extendedInfo = null, uint? page = null, uint? limit = null,
            CancellationToken cancellationToken = default)
        {
            ...
            return GetShowListsImplAsync(showIDs.BestID, listType, listSortOrder, extendedInfo, page, limit, cancellationToken);
        }
    }
}
