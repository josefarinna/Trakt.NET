namespace TraktNET
{
    ...
    {
        /// <summary>Gets all <see cref="TraktList" />s containing a <see cref="TraktPerson" /> with the given Trakt-Id or -Slug.</summary>
        ...
        /// </param>
        /// <returns>
        /// A paged response of type <see cref="TraktPagedResponse{TResponseContentType}" /> containing the queried person lists.
        /// <para />
        ...
        public Task<TraktPagedResponse<TraktList>> GetPersonListsAsync(string personIdOrSlug, TraktListType? listType = null,
            TraktListSortOrder? listSortOrder = null, TraktExtendedInfo? extendedInfo = null, uint? page = null, uint? limit = null,
            CancellationToken cancellationToken = default)
            => GetPersonListsImplAsync(personIdOrSlug, listType, listSortOrder, extendedInfo, page, limit, cancellationToken);
        ...
        public Task<TraktPagedResponse<TraktList>> GetPersonListsAsync(uint traktPersonId, TraktListType? listType = null,
            TraktListSortOrder? listSortOrder = null, TraktExtendedInfo? extendedInfo = null, uint? page = null, uint? limit = null,
            CancellationToken cancellationToken = default)
        {
            if (traktPersonId == 0)
            ...
            return GetPersonListsAsync(traktPersonId.ToInvariantCultureString(), listType, listSortOrder, extendedInfo, page, limit, cancellationToken);
        }
        ...
        public Task<TraktPagedResponse<TraktList>> GetPersonListsAsync(TraktPersonIDs personIds, TraktListType? listType = null,
            TraktListSortOrder? listSortOrder = null, TraktExtendedInfo? extendedInfo = null, uint? page = null, uint? limit = null,
            CancellationToken cancellationToken = default)
        {
            ...
            return GetPersonListsAsync(personIds.BestID, listType, listSortOrder, extendedInfo, page, limit, cancellationToken);
        }
        ...
        public Task<TraktPagedResponse<TraktList>> GetPersonListsAsync(TraktPerson person, TraktListType? listType = null,
            TraktListSortOrder? listSortOrder = null, TraktExtendedInfo? extendedInfo = null, uint? page = null, uint? limit = null,
            CancellationToken cancellationToken = default)
        {
            ArgumentValidator.ThrowIfNull(person);

            return GetPersonListsAsync(person.IDs!, listType, listSortOrder, extendedInfo, page, limit, cancellationToken);
        }
    }
}
