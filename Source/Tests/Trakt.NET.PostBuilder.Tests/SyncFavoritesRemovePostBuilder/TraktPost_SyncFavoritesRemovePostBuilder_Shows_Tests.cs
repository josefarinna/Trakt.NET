namespace TraktNet.PostBuilder.Tests
{
    ...
    {
        [Fact]
        public void Test_TraktPost_SyncFavoritesRemovePostBuilder_WithShow_ITraktShow()
        {
            ...
            syncFavoritesRemovePost.Shows.Should().NotBeNull().And.HaveCount(1);

            ITraktSyncFavoritesPostShow postShow = syncFavoritesRemovePost.Shows.ToArray()[0];
            ...
            syncFavoritesRemovePost.Movies.Should().BeNull();
        }

        [Fact]
        public void Test_TraktPost_SyncFavoritesRemovePostBuilder_WithShow_ITraktShowIds()
        {
            ITraktSyncFavoritesRemovePost syncFavoritesRemovePost = TraktPost.NewSyncFavoritesRemovePost()
        ...
        [Fact]
        public void Test_TraktPost_SyncFavoritesRemovePostBuilder_WithShows_ITraktShow()
        {
            ITraktSyncFavoritesRemovePost syncFavoritesRemovePost = TraktPost.NewSyncFavoritesRemovePost()
            ...
            syncFavoritesRemovePost.Should().NotBeNull();
            syncFavoritesRemovePost.Shows.Should().NotBeNull().And.HaveCount(2);

            ITraktSyncFavoritesPostShow postShow1 = syncFavoritesRemovePost.Shows.ToArray()[0];
            ...
            ITraktSyncFavoritesPostShow postShow2 = syncFavoritesRemovePost.Shows.ToArray()[1];
        ...
        [Fact]
        public void Test_TraktPost_SyncFavoritesRemovePostBuilder_WithShows_ITraktShowIds()
        {
            ITraktSyncFavoritesRemovePost syncFavoritesRemovePost = TraktPost.NewSyncFavoritesRemovePost()
