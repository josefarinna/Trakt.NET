namespace TraktNet.Modules.Tests.TraktEpisodesModule
{
    ...
    public partial class TraktEpisodesModule_Tests
    {
        ...
        public async Task Test_TraktEpisodesModule_GetEpisodeComments_With_Page()
        {
            ...
            TraktPagedResponse<ITraktComment> response = await client.Episodes.GetEpisodeCommentsAsync(SHOW_ID, SEASON_NR, EPISODE_NR, null, null, pagedParameters, TestContext.Current.CancellationToken);
        ...
        public async Task Test_TraktEpisodesModule_GetEpisodeComments_With_SortOrder_And_Page()
        {
            ...
            var pagedParameters = new TraktPagedParameters(PAGE);
            TraktPagedResponse<ITraktComment> response = await client.Episodes.GetEpisodeCommentsAsync(SHOW_ID, SEASON_NR, EPISODE_NR, COMMENT_SORT_ORDER, null, pagedParameters, TestContext.Current.CancellationToken);
        ...
        public async Task Test_TraktEpisodesModule_GetEpisodeComments_With_ExtendedInfo_And_Page()
        {
            ...
            var pagedParameters = new TraktPagedParameters(PAGE);
            TraktPagedResponse<ITraktComment> response = await client.Episodes.GetEpisodeCommentsAsync(SHOW_ID, SEASON_NR, EPISODE_NR, null, EXTENDED_INFO, pagedParameters, TestContext.Current.CancellationToken);
        ...
        public async Task Test_TraktEpisodesModule_GetEpisodeComments_Complete()
        {
            ...
            var pagedParameters = new TraktPagedParameters(PAGE, LIMIT);
            TraktPagedResponse<ITraktComment> response = await client.Episodes.GetEpisodeCommentsAsync(SHOW_ID, SEASON_NR, EPISODE_NR, COMMENT_SORT_ORDER, EXTENDED_INFO, pagedParameters, TestContext.Current.CancellationToken);
