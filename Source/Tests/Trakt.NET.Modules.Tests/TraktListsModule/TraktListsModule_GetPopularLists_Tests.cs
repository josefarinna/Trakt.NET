namespace TraktNet.Modules.Tests.TraktListsModule
{
    ...
    public partial class TraktListsModule_Tests
    {
        ...
        {
            TraktClient client = TestUtility.GetMockClient(GET_POPULAR_LISTS_URI, TRENDING_OR_POPULAR_LISTS_JSON, 1, 10, 1, ITEM_COUNT);

            TraktPagedResponse<ITraktPopularList> response = await client.Lists.GetPopularListsAsync();
        ...
        public async Task Test_TraktListsModule_GetPopularLists_With_ExtendedInfo()
        {
            ...
            TraktPagedResponse<ITraktPopularList> response = await client.Lists.GetPopularListsAsync(EXTENDED_INFO);
        ...
        public async Task Test_TraktListsModule_GetPopularLists_With_Page()
        {
            ...
            TraktPagedResponse<ITraktPopularList> response = await client.Lists.GetPopularListsAsync(null, pagedParameters, TestContext.Current.CancellationToken);
        ...
        public async Task Test_TraktListsModule_GetPopularLists_With_ExtendedInfo_And_Page()
        {
            ...
            var pagedParameters = new TraktPagedParameters(PAGE);
            TraktPagedResponse<ITraktPopularList> response = await client.Lists.GetPopularListsAsync(EXTENDED_INFO, pagedParameters, TestContext.Current.CancellationToken);
