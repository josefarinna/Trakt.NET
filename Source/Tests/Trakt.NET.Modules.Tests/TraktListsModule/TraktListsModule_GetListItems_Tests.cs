namespace TraktNet.Modules.Tests.TraktListsModule
{
    ...
    public partial class TraktListsModule_Tests
    {
        ...
        [Fact]
        public async Task Test_TraktListsModule_GetListItems_With_List()
        {
            ...
            TraktPagedResponse<ITraktListItem> response = await client.Lists.GetListItemsAsync(list);
        ...
        public async Task Test_TraktListsModule_GetListItems_Throws_ArgumentExceptions()
        {
            ...
            act = () => client.Lists.GetListItemsAsync(default(ITraktList));
            await act.Should().ThrowAsync<ArgumentNullException>();
