namespace TraktNet.Modules.Tests.TraktSyncModule
{
    ...
    public partial class TraktSyncModule_Tests
    {
        ...
        public async Task Test_TraktSyncModule_GetWatchedHistory_With_StartDate_And_ExtendedInfo_And_Page_And_Limit()
        {
            ...
            TraktPagedResponse<ITraktHistoryItem> response =
                await client.Sync.GetWatchedHistoryAsync(null, null, START_AT, null, EXTENDED_INFO, pagedParameters, TestContext.Current.CancellationToken);
        ...
        public async Task Test_TraktSyncModule_GetWatchedHistory_With_EndDate_And_ExtendedInfo_And_Page_And_Limit()
        {
            ...
            TraktPagedResponse<ITraktHistoryItem> response =
                await client.Sync.GetWatchedHistoryAsync(null, null, null, END_AT, EXTENDED_INFO, pagedParameters, TestContext.Current.CancellationToken);
        ...
        public async Task Test_TraktSyncModule_GetWatchedHistory_With_EndDate_And_Page()
        {
            ...
            TraktPagedResponse<ITraktHistoryItem> response =
                await client.Sync.GetWatchedHistoryAsync(null, null, null, END_AT, null, pagedParameters, TestContext.Current.CancellationToken);
        ...
        public async Task Test_TraktSyncModule_GetWatchedHistory_With_Page()
        {
            ...
            TraktPagedResponse<ITraktHistoryItem> response =
                await client.Sync.GetWatchedHistoryAsync(null, null, null, null, null, pagedParameters, TestContext.Current.CancellationToken);
        ...
        [Fact]
        public async Task Test_TraktSyncModule_GetWatchedHistory_Paging_HasPreviousPage_And_HasNextPage()
        {
            TraktClient client = TestUtility.GetOAuthMockClient(
                $"{GET_WATCHED_HISTORY_URI}/{HISTORY_ITEM_TYPE.UriName}/{HISTORY_ITEM_ID}" +
                $"?start_at={START_AT.ToTraktLongDateTimeString()}&end_at={END_AT.ToTraktLongDateTimeString()}" +
                $"&extended={EXTENDED_INFO}&page=2&limit={LIMIT}",
                WATCHED_HISTORY_JSON, 2, LIMIT, 5, ITEM_COUNT);
        ...
        [Fact]
        public async Task Test_TraktSyncModule_GetWatchedHistory_Paging_Only_HasPreviousPage()
        {
            TraktClient client = TestUtility.GetOAuthMockClient(
                $"{GET_WATCHED_HISTORY_URI}/{HISTORY_ITEM_TYPE.UriName}/{HISTORY_ITEM_ID}" +
                $"?start_at={START_AT.ToTraktLongDateTimeString()}&end_at={END_AT.ToTraktLongDateTimeString()}" +
                $"&extended={EXTENDED_INFO}&page=2&limit={LIMIT}",
                WATCHED_HISTORY_JSON, 2, LIMIT, 2, ITEM_COUNT);
        ...
        [Fact]
        public async Task Test_TraktSyncModule_GetWatchedHistory_Paging_Only_HasNextPage()
        {
            TraktClient client = TestUtility.GetOAuthMockClient(
                $"{GET_WATCHED_HISTORY_URI}/{HISTORY_ITEM_TYPE.UriName}/{HISTORY_ITEM_ID}" +
                $"?start_at={START_AT.ToTraktLongDateTimeString()}&end_at={END_AT.ToTraktLongDateTimeString()}" +
                $"&extended={EXTENDED_INFO}&page=1&limit={LIMIT}",
                WATCHED_HISTORY_JSON, 1, LIMIT, 2, ITEM_COUNT);
        ...
        [Fact]
        public async Task Test_TraktSyncModule_GetWatchedHistory_Paging_Not_HasPreviousPage_Or_HasNextPage()
        {
            TraktClient client = TestUtility.GetOAuthMockClient(
                $"{GET_WATCHED_HISTORY_URI}/{HISTORY_ITEM_TYPE.UriName}/{HISTORY_ITEM_ID}" +
                $"?start_at={START_AT.ToTraktLongDateTimeString()}&end_at={END_AT.ToTraktLongDateTimeString()}" +
        ...
        [Fact]
        public async Task Test_TraktSyncModule_GetWatchedHistory_Paging_GetPreviousPage()
        {
            TraktClient client = TestUtility.GetOAuthMockClient(
                $"{GET_WATCHED_HISTORY_URI}/{HISTORY_ITEM_TYPE.UriName}/{HISTORY_ITEM_ID}" +
                $"?start_at={START_AT.ToTraktLongDateTimeString()}&end_at={END_AT.ToTraktLongDateTimeString()}" +
        ...
        [Fact]
        public async Task Test_TraktSyncModule_GetWatchedHistory_Paging_GetNextPage()
        {
            TraktClient client = TestUtility.GetOAuthMockClient(
                $"{GET_WATCHED_HISTORY_URI}/{HISTORY_ITEM_TYPE.UriName}/{HISTORY_ITEM_ID}" +
                $"?start_at={START_AT.ToTraktLongDateTimeString()}&end_at={END_AT.ToTraktLongDateTimeString()}" +
