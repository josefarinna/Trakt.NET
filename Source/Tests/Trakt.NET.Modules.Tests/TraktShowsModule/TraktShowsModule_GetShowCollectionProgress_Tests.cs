namespace TraktNet.Modules.Tests.TraktShowsModule
{
    ...
    public partial class TraktShowsModule_Tests
    {
        ...
        [Fact]
        public async Task Test_TraktShowsModule_GetShowCollectionProgress_With_TraktID()
        {
            TraktClient client = TestUtility.GetOAuthMockClient($"shows/{TRAKT_SHOD_ID}/progress/collection", SHOW_COLLECTION_PROGRESS_JSON);
            TraktResponse<ITraktShowCollectionProgress> response = await client.Shows.GetShowCollectionProgressAsync(TRAKT_SHOD_ID);
        ...
        [Fact]
        public async Task Test_TraktShowsModule_GetShowCollectionProgress_With_ShowIds_TraktID()
        {
            ...
            TraktClient client = TestUtility.GetOAuthMockClient($"shows/{TRAKT_SHOD_ID}/progress/collection", SHOW_COLLECTION_PROGRESS_JSON);
            TraktResponse<ITraktShowCollectionProgress> response = await client.Shows.GetShowCollectionProgressAsync(showIds);
        ...
        [Fact]
        public async Task Test_TraktShowsModule_GetShowCollectionProgress_With_ShowIds_Slug()
        {
            var showIds = new TraktShowIds
            {
                Slug = SHOW_SLUG
            ...
            TraktClient client = TestUtility.GetOAuthMockClient($"shows/{SHOW_SLUG}/progress/collection", SHOW_COLLECTION_PROGRESS_JSON);
            TraktResponse<ITraktShowCollectionProgress> response = await client.Shows.GetShowCollectionProgressAsync(showIds);
        ...
        [Fact]
        public async Task Test_TraktShowsModule_GetShowCollectionProgress_With_ShowIds()
        {
            var showIds = new TraktShowIds
            {
                Trakt = TRAKT_SHOD_ID,
        ...
        [Fact]
        public async Task Test_TraktShowsModule_GetShowCollectionProgress_With_Show()
        {
            ...
            TraktClient client = TestUtility.GetOAuthMockClient($"shows/{TRAKT_SHOD_ID}/progress/collection", SHOW_COLLECTION_PROGRESS_JSON);
            TraktResponse<ITraktShowCollectionProgress> response = await client.Shows.GetShowCollectionProgressAsync(show);
        ...
        [Fact]
        public async Task Test_TraktShowsModule_GetShowCollectionProgress_With_Hidden_And_LastActivity()
        {
            TraktClient client = TestUtility.GetOAuthMockClient(
                $"{GET_SHOW_COLLECTION_PROGRESS_URI}?hidden={ProgressHidden}&last_activity={LastActivity}",
                SHOW_COLLECTION_PROGRESS_JSON);

            TraktResponse<ITraktShowCollectionProgress> response =
                await client.Shows.GetShowCollectionProgressAsync(SHOW_ID, PROGRESS_HIDDEN, null, null, LAST_ACTIVITY);
        ...
        [Fact]
        public async Task Test_TraktShowsModule_GetShowCollectionProgress_With_Specials_And_LastActivity()
        {
            TraktClient client = TestUtility.GetOAuthMockClient(
                $"{GET_SHOW_COLLECTION_PROGRESS_URI}?specials={ProgressSpecials}&last_activity={LastActivity}",
                SHOW_COLLECTION_PROGRESS_JSON);

            TraktResponse<ITraktShowCollectionProgress> response =
                await client.Shows.GetShowCollectionProgressAsync(SHOW_ID, null, PROGRESS_SPECIALS, null, LAST_ACTIVITY);
        ...
        [Fact]
        public async Task Test_TraktShowsModule_GetShowCollectionProgress_With_LastActivity()
        {
            TraktClient client = TestUtility.GetOAuthMockClient(
                $"{GET_SHOW_COLLECTION_PROGRESS_URI}?last_activity={LastActivity}",
                SHOW_COLLECTION_PROGRESS_JSON);

            TraktResponse<ITraktShowCollectionProgress> response =
                await client.Shows.GetShowCollectionProgressAsync(SHOW_ID, null, null, null, LAST_ACTIVITY);
        ...
        {
            TraktClient client = TestUtility.GetOAuthMockClient(
                $"{GET_SHOW_COLLECTION_PROGRESS_URI}?hidden={ProgressHidden}&specials={ProgressSpecials}&count_specials={ProgressCountSpecials}&last_activity={LastActivity}",
                SHOW_COLLECTION_PROGRESS_JSON);

            TraktResponse<ITraktShowCollectionProgress> response =
                await client.Shows.GetShowCollectionProgressAsync(SHOW_ID, PROGRESS_HIDDEN, PROGRESS_SPECIALS, PROGRESS_COUNT_SPECIALS, LAST_ACTIVITY);
        ...
        [Fact]
        public async Task Test_TraktShowsModule_GetShowCollectionProgress_Throws_ArgumentExceptions()
        {
            TraktClient client = TestUtility.GetOAuthMockClient(GET_SHOW_COLLECTION_PROGRESS_URI, SHOW_COLLECTION_PROGRESS_JSON);

            Func<Task<TraktResponse<ITraktShowCollectionProgress>>> act = () => client.Shows.GetShowCollectionProgressAsync(default(ITraktShowIds));
            await act.Should().ThrowAsync<ArgumentNullException>();

            act = () => client.Shows.GetShowCollectionProgressAsync(default(ITraktShow));
            await act.Should().ThrowAsync<ArgumentNullException>();

            act = () => client.Shows.GetShowCollectionProgressAsync(new TraktShowIds());
            await act.Should().ThrowAsync<ArgumentException>();

            act = () => client.Shows.GetShowCollectionProgressAsync(0);
            await act.Should().ThrowAsync<ArgumentException>();
        }
    }
}
