namespace TraktNet.Modules.Tests.TraktShowsModule
{
    ...
    public partial class TraktShowsModule_Tests
    {
        ...
        public async Task Test_TraktShowsModule_GetMostWatchedShows_Throws_API_Exception(HttpStatusCode statusCode, Type exceptionType)
        {
            TraktClient client = TestUtility.GetMockClient(GET_MOST_WATCHED_SHOWS_URI, statusCode);

            try
            {
                await client.Shows.GetMostWatchedShowsAsync();
                Assert.False(true);
            }
