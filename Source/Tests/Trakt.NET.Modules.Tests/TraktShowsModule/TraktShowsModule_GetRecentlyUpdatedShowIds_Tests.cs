    ...
    public partial class TraktShowsModule_Tests
    {
        ...
        public async Task Test_TraktShowsModule_GetRecentlyUpdatedShowIds_With_StartDate()
        {
            ...
            TraktClient client = TestUtility.GetMockClient(
                $"{GET_RECENTLY_UPDATED_SHOW_IDS_URI}/{startDate}",
                RECENTLY_UPDATED_SHOW_IDS_JSON, 1, 10, 1, UPDATED_IDS_COUNT);

            TraktPagedResponse<int> response = await client.Shows.GetRecentlyUpdatedShowIdsAsync(START_DATE);
        ...
        public async Task Test_TraktShowsModule_GetRecentlyUpdatedShowIds_With_StartDate_And_Page()
        {
            ...
            TraktClient client = TestUtility.GetMockClient(
                $"{GET_RECENTLY_UPDATED_SHOW_IDS_URI}/{startDate}?page={PAGE}",
                RECENTLY_UPDATED_SHOW_IDS_JSON, PAGE, 10, 1, UPDATED_IDS_COUNT);
        ...
        public async Task Test_TraktShowsModule_GetRecentlyUpdatedShowIds_With_StartDate_And_Limit()
        {
            ...
            TraktClient client = TestUtility.GetMockClient(
                $"{GET_RECENTLY_UPDATED_SHOW_IDS_URI}/{startDate}?limit={LIMIT}",
                RECENTLY_UPDATED_SHOW_IDS_JSON, 1, LIMIT, 1, UPDATED_IDS_COUNT);
        ...
        public async Task Test_TraktShowsModule_GetRecentlyUpdatedShowIds_Complete()
        {
            ...
            TraktClient client = TestUtility.GetMockClient(
                $"{GET_RECENTLY_UPDATED_SHOW_IDS_URI}/{startDate}?page={PAGE}&limit={LIMIT}",
                RECENTLY_UPDATED_SHOW_IDS_JSON, PAGE, LIMIT, 1, UPDATED_IDS_COUNT);
        ...
        [Fact]
        public async Task Test_TraktShowsModule_GetRecentlyUpdatedShowIds_Paging_HasPreviousPage_And_HasNextPage()
        {
            var startDate = TestUtility.EncodeForURL(START_DATE.ToTraktCacheEfficientLongDateTimeString());
        ...
        [Fact]
        public async Task Test_TraktShowsModule_GetRecentlyUpdatedShowIds_Paging_Only_HasPreviousPage()
        {
            var startDate = TestUtility.EncodeForURL(START_DATE.ToTraktCacheEfficientLongDateTimeString());
        ...
        [Fact]
        public async Task Test_TraktShowsModule_GetRecentlyUpdatedShowIds_Paging_Only_HasNextPage()
        {
            var startDate = TestUtility.EncodeForURL(START_DATE.ToTraktCacheEfficientLongDateTimeString());
        ...
        [Fact]
        public async Task Test_TraktShowsModule_GetRecentlyUpdatedShowIds_Paging_Not_HasPreviousPage_Or_HasNextPage()
        {
            var startDate = TestUtility.EncodeForURL(START_DATE.ToTraktCacheEfficientLongDateTimeString());
        ...
        [Fact]
        public async Task Test_TraktShowsModule_GetRecentlyUpdatedShowIds_Paging_GetPreviousPage()
        {
            var startDate = TestUtility.EncodeForURL(START_DATE.ToTraktCacheEfficientLongDateTimeString());
        ...
        [Fact]
        public async Task Test_TraktShowsModule_GetRecentlyUpdatedShowIds_Paging_GetNextPage()
        {
            var startDate = TestUtility.EncodeForURL(START_DATE.ToTraktCacheEfficientLongDateTimeString());
