namespace TraktNet.Modules.Tests.TraktShowsModule
{
    ...
    public partial class TraktShowsModule_Tests
    {
        ...
        [Fact]
        public async Task Test_TraktShowsModule_GetMostCollectedShows_Paging_HasPreviousPage_And_HasNextPage()
        {
            TraktClient client = TestUtility.GetMockClient(
                $"{GET_MOST_COLLECTED_SHOWS_URI}/{TIME_PERIOD.UriName}?extended={EXTENDED_INFO}&page=2&limit={LIMIT}",
                MOST_COLLECTED_SHOWS_JSON, 2, LIMIT, 5, ITEM_COUNT);
        ...
        [Fact]
        public async Task Test_TraktShowsModule_GetMostCollectedShows_Paging_Only_HasPreviousPage()
        {
            TraktClient client = TestUtility.GetMockClient(
                $"{GET_MOST_COLLECTED_SHOWS_URI}/{TIME_PERIOD.UriName}?extended={EXTENDED_INFO}&page=2&limit={LIMIT}",
        ...
        [Fact]
        public async Task Test_TraktShowsModule_GetMostCollectedShows_Paging_Only_HasNextPage()
        {
            TraktClient client = TestUtility.GetMockClient(
        ...
        [Fact]
        public async Task Test_TraktShowsModule_GetMostCollectedShows_Paging_Not_HasPreviousPage_Or_HasNextPage()
        {
            TraktClient client = TestUtility.GetMockClient(
                $"{GET_MOST_COLLECTED_SHOWS_URI}/{TIME_PERIOD.UriName}?extended={EXTENDED_INFO}&page=1&limit={LIMIT}",
                MOST_COLLECTED_SHOWS_JSON, 1, LIMIT, 1, ITEM_COUNT);
        ...
        [Fact]
        public async Task Test_TraktShowsModule_GetMostCollectedShows_Paging_GetPreviousPage()
        {
            TraktClient client = TestUtility.GetMockClient(
                $"{GET_MOST_COLLECTED_SHOWS_URI}/{TIME_PERIOD.UriName}?extended={EXTENDED_INFO}&page=2&limit={LIMIT}",
                MOST_COLLECTED_SHOWS_JSON, 2, LIMIT, 2, ITEM_COUNT);
        ...
        [Fact]
        public async Task Test_TraktShowsModule_GetMostCollectedShows_Paging_GetNextPage()
        {
            TraktClient client = TestUtility.GetMockClient(
                $"{GET_MOST_COLLECTED_SHOWS_URI}/{TIME_PERIOD.UriName}?extended={EXTENDED_INFO}&page=1&limit={LIMIT}",
                MOST_COLLECTED_SHOWS_JSON, 1, LIMIT, 2, ITEM_COUNT);
