namespace TraktNet.Modules.Tests.TraktMoviesModule
{
    ...
    public partial class TraktMoviesModule_Tests
    {
        ...
        [Fact]
        public async Task Test_TraktMoviesModule_GetPopularMovies_Paging_HasPreviousPage_And_HasNextPage()
        {
            TraktClient client = TestUtility.GetMockClient($"{GET_POPULAR_MOVIES_URI}?extended={EXTENDED_INFO}&page=2&limit={LIMIT}",
        ...
        [Fact]
        public async Task Test_TraktMoviesModule_GetPopularMovies_Paging_Only_HasPreviousPage()
        {
            TraktClient client = TestUtility.GetMockClient($"{GET_POPULAR_MOVIES_URI}?extended={EXTENDED_INFO}&page=2&limit={LIMIT}",
        ...
        [Fact]
        public async Task Test_TraktMoviesModule_GetPopularMovies_Paging_Only_HasNextPage()
        {
            TraktClient client = TestUtility.GetMockClient($"{GET_POPULAR_MOVIES_URI}?extended={EXTENDED_INFO}&page=1&limit={LIMIT}",
        ...
        [Fact]
        public async Task Test_TraktMoviesModule_GetPopularMovies_Paging_Not_HasPreviousPage_Or_HasNextPage()
        {
            TraktClient client = TestUtility.GetMockClient($"{GET_POPULAR_MOVIES_URI}?extended={EXTENDED_INFO}&page=1&limit={LIMIT}",
                POPULAR_MOVIES_JSON, 1, LIMIT, 1, ITEM_COUNT);
        ...
        [Fact]
        public async Task Test_TraktMoviesModule_GetPopularMovies_Paging_GetPreviousPage()
        {
            TraktClient client = TestUtility.GetMockClient($"{GET_POPULAR_MOVIES_URI}?extended={EXTENDED_INFO}&page=2&limit={LIMIT}",
                POPULAR_MOVIES_JSON, 2, LIMIT, 2, ITEM_COUNT);
        ...
        [Fact]
        public async Task Test_TraktMoviesModule_GetPopularMovies_Paging_GetNextPage()
        {
            TraktClient client = TestUtility.GetMockClient($"{GET_POPULAR_MOVIES_URI}?extended={EXTENDED_INFO}&page=1&limit={LIMIT}",
                POPULAR_MOVIES_JSON, 1, LIMIT, 2, ITEM_COUNT);
