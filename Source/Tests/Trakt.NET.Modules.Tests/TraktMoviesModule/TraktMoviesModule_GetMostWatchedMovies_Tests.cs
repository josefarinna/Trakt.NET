namespace TraktNet.Modules.Tests.TraktMoviesModule
{
    ...
    public partial class TraktMoviesModule_Tests
    {
        ...
        public async Task Test_TraktMoviesModule_GetMostWatchedMovies_With_Page()
        {
            ...
            TraktPagedResponse<ITraktMostPWCMovie> response = await client.Movies.GetMostWatchedMoviesAsync(null, null, null, pagedParameters, TestContext.Current.CancellationToken);
        ...
        public async Task Test_TraktMoviesModule_GetMostWatchedMovies_With_Page_Filtered()
        {
            ...
            var pagedParameters = new TraktPagedParameters(PAGE);
            TraktPagedResponse<ITraktMostPWCMovie> response = await client.Movies.GetMostWatchedMoviesAsync(null, null, FILTER, pagedParameters, TestContext.Current.CancellationToken);
        ...
        public async Task Test_TraktMoviesModule_GetMostWatchedMovies_With_TimePeriod_And_Page()
        {
            ...
            var pagedParameters = new TraktPagedParameters(PAGE);
            TraktPagedResponse<ITraktMostPWCMovie> response = await client.Movies.GetMostWatchedMoviesAsync(TIME_PERIOD, null, null, pagedParameters, TestContext.Current.CancellationToken);
        ...
        public async Task Test_TraktMoviesModule_GetMostWatchedMovies_With_TimePeriod_And_Page_Filtered()
        {
            ...
            var pagedParameters = new TraktPagedParameters(PAGE);
            TraktPagedResponse<ITraktMostPWCMovie> response = await client.Movies.GetMostWatchedMoviesAsync(TIME_PERIOD, null, FILTER, pagedParameters, TestContext.Current.CancellationToken);
        ...
        public async Task Test_TraktMoviesModule_GetMostWatchedMovies_With_ExtendedInfo_And_Page()
        {
            ...
            var pagedParameters = new TraktPagedParameters(PAGE);
            TraktPagedResponse<ITraktMostPWCMovie> response = await client.Movies.GetMostWatchedMoviesAsync(null, EXTENDED_INFO, null, pagedParameters, TestContext.Current.CancellationToken);
        ...
        public async Task Test_TraktMoviesModule_GetMostWatchedMovies_With_ExtendedInfo_And_Page_Filtered()
        {
            ...
            var pagedParameters = new TraktPagedParameters(PAGE);
            TraktPagedResponse<ITraktMostPWCMovie> response = await client.Movies.GetMostWatchedMoviesAsync(null, EXTENDED_INFO, FILTER, pagedParameters, TestContext.Current.CancellationToken);
        ...
        public async Task Test_TraktMoviesModule_GetMostWatchedMovies_Complete()
        {
            ...
            var pagedParameters = new TraktPagedParameters(PAGE, LIMIT);
            TraktPagedResponse<ITraktMostPWCMovie> response = await client.Movies.GetMostWatchedMoviesAsync(TIME_PERIOD, EXTENDED_INFO, null, pagedParameters, TestContext.Current.CancellationToken);
        ...
        public async Task Test_TraktMoviesModule_GetMostWatchedMovies_Complete_Filtered()
        {
            ...
            var pagedParameters = new TraktPagedParameters(PAGE, LIMIT);
            TraktPagedResponse<ITraktMostPWCMovie> response = await client.Movies.GetMostWatchedMoviesAsync(TIME_PERIOD, EXTENDED_INFO, FILTER, pagedParameters, TestContext.Current.CancellationToken);
        ...
        [Fact]
        public async Task Test_TraktMoviesModule_GetMostWatchedMovies_Paging_HasPreviousPage_And_HasNextPage()
        {
            TraktClient client = TestUtility.GetMockClient(
                $"{GET_MOST_WATCHED_MOVIES_URI}/{TIME_PERIOD.UriName}?extended={EXTENDED_INFO}&page=2&limit={LIMIT}",
                MOST_WATCHED_MOVIES_JSON, 2, LIMIT, 5, ITEM_COUNT);

            var pagedParameters = new TraktPagedParameters(2, LIMIT);

            TraktPagedResponse<ITraktMostPWCMovie> response =
                await client.Movies.GetMostWatchedMoviesAsync(TIME_PERIOD, EXTENDED_INFO, null, pagedParameters, TestContext.Current.CancellationToken);
        ...
        [Fact]
        public async Task Test_TraktMoviesModule_GetMostWatchedMovies_Paging_Only_HasPreviousPage()
        {
            TraktClient client = TestUtility.GetMockClient(
                $"{GET_MOST_WATCHED_MOVIES_URI}/{TIME_PERIOD.UriName}?extended={EXTENDED_INFO}&page=2&limit={LIMIT}",
                MOST_WATCHED_MOVIES_JSON, 2, LIMIT, 2, ITEM_COUNT);
        ...
        [Fact]
        public async Task Test_TraktMoviesModule_GetMostWatchedMovies_Paging_Only_HasNextPage()
        {
            TraktClient client = TestUtility.GetMockClient(
                $"{GET_MOST_WATCHED_MOVIES_URI}/{TIME_PERIOD.UriName}?extended={EXTENDED_INFO}&page=1&limit={LIMIT}",
                MOST_WATCHED_MOVIES_JSON, 1, LIMIT, 2, ITEM_COUNT);
        ...
        [Fact]
        public async Task Test_TraktMoviesModule_GetMostWatchedMovies_Paging_Not_HasPreviousPage_Or_HasNextPage()
        {
            TraktClient client = TestUtility.GetMockClient(
                $"{GET_MOST_WATCHED_MOVIES_URI}/{TIME_PERIOD.UriName}?extended={EXTENDED_INFO}&page=1&limit={LIMIT}",
                MOST_WATCHED_MOVIES_JSON, 1, LIMIT, 1, ITEM_COUNT);
        ...
        [Fact]
        public async Task Test_TraktMoviesModule_GetMostWatchedMovies_Paging_GetPreviousPage()
        {
            TraktClient client = TestUtility.GetMockClient(
                $"{GET_MOST_WATCHED_MOVIES_URI}/{TIME_PERIOD.UriName}?extended={EXTENDED_INFO}&page=2&limit={LIMIT}",
                MOST_WATCHED_MOVIES_JSON, 2, LIMIT, 2, ITEM_COUNT);
        ...
        [Fact]
        public async Task Test_TraktMoviesModule_GetMostWatchedMovies_Paging_GetNextPage()
        {
            TraktClient client = TestUtility.GetMockClient(
                $"{GET_MOST_WATCHED_MOVIES_URI}/{TIME_PERIOD.UriName}?extended={EXTENDED_INFO}&page=1&limit={LIMIT}",
                MOST_WATCHED_MOVIES_JSON, 1, LIMIT, 2, ITEM_COUNT);
        ...
        public async Task Test_TraktMoviesModule_GetMostWatchedMovies_Throws_API_Exception(HttpStatusCode statusCode, Type exceptionType)
        {
            TraktClient client = TestUtility.GetMockClient(GET_MOST_WATCHED_MOVIES_URI, statusCode);
