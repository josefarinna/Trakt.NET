namespace TraktNet.Modules.Tests.TraktMoviesModule
{
    ...
    public partial class TraktMoviesModule_Tests
    {
        ...
        public async Task Test_TraktMoviesModule_GetMostCollectedMovies_Throws_API_Exception(HttpStatusCode statusCode, Type exceptionType)
        {
            TraktClient client = TestUtility.GetMockClient(GET_MOST_COLLECTED_MOVIES_URI, statusCode);
