namespace TraktNet.Modules.Tests.TraktMoviesModule
{
    ...
    public partial class TraktMoviesModule_Tests
    {
        ...
        public async Task Test_TraktMoviesModule_GetMovieComments_Throws_API_Exception(HttpStatusCode statusCode, Type exceptionType)
        {
            TraktClient client = TestUtility.GetMockClient(GET_MOVIE_COMMENTS_URI, statusCode);

            try
            {
                await client.Movies.GetMovieCommentsAsync(MOVIE_ID);
                Assert.False(true);
            }
