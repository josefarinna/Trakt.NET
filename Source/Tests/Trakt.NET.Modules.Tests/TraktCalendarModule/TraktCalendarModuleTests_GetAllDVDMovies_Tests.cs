namespace TraktNet.Modules.Tests.TraktCalendarModule
{
    ...
    public partial class TraktCalendarModule_Tests
    {
        ...
        public async Task Test_TraktCalendarModule_GetAllDVDMovies_Throws_API_Exception(HttpStatusCode statusCode, Type exceptionType)
        {
            TraktClient client = TestUtility.GetMockClient(GET_ALL_DVD_MOVIES_URI, statusCode);
