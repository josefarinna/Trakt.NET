namespace TraktNet.Modules.Tests.TraktUsersModule
{
    ...
    public partial class TraktUsersModule_Tests
    {
        ...
        [Fact]
        public async Task Test_TraktUsersModule_GetCollectionMovies_With_OAuth_Enforced_For_Username_Me()
        {
            TraktClient client = TestUtility.GetOAuthMockClient("users/me/collection/movies", COLLECTION_MOVIES_JSON);
            TraktListResponse<ITraktCollectionMovie> response = await client.Users.GetCollectionMoviesAsync("me");
