namespace TraktNet.Modules.Tests.TraktUsersModule
{
    ...
    public partial class TraktUsersModule_Tests
    {
        ...
        [Fact]
        public async Task Test_TraktUsersModule_LikeList_With_ListIds_TraktID()
        {
        ...
        [Fact]
        public async Task Test_TraktUsersModule_LikeList_With_ListIds_Slug()
        {
            var listIds = new TraktListIds
            {
                Slug = LIST_SLUG
        ...
        [Fact]
        public async Task Test_TraktUsersModule_LikeList_With_ListIds()
        {
            var listIds = new TraktListIds
            {
                Trakt = TRAKT_LIST_ID,
        ...
        [Fact]
        public async Task Test_TraktUsersModule_LikeList_With_List()
        {
        ...
        [Fact]
        public async Task Test_TraktUsersModule_LikeList_Throws_ArgumentExceptions()
        {
            TraktClient client = TestUtility.GetOAuthMockClient(LIKE_LIST_URI, HttpStatusCode.NoContent);
