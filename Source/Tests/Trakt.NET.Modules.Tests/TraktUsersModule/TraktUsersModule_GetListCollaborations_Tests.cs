namespace TraktNet.Modules.Tests.TraktUsersModule
{
    ...
    public partial class TraktUsersModule_Tests
    {
        ...
        [Fact]
        public async Task Test_TraktUsersModule_GetListCollaborations_With_OAuth_Enfored_For_Username_Me()
        {
            TraktClient client = TestUtility.GetOAuthMockClient("users/me/lists/collaborations", LISTS_JSON);
            TraktListResponse<ITraktList> response = await client.Users.GetListCollaborationsAsync("me");
