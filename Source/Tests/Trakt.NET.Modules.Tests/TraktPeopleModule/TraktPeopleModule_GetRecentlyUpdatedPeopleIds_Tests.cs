namespace TraktNet.Modules.Tests.TraktPeopleModule
{
    ...
    public partial class TraktPeopleModule_Tests
    {
        ...
        [Fact]
        public async Task Test_TraktPeopleModule_GetRecentlyUpdatedPeopleIds_Paging_HasPreviousPage_And_HasNextPage()
        {
            var startDate = TestUtility.EncodeForURL(START_DATE.ToTraktCacheEfficientLongDateTimeString());
        ...
        [Fact]
        public async Task Test_TraktPeopleModule_GetRecentlyUpdatedPeopleIds_Paging_Only_HasPreviousPage()
        {
            var startDate = TestUtility.EncodeForURL(START_DATE.ToTraktCacheEfficientLongDateTimeString());
        ...
        [Fact]
        public async Task Test_TraktPeopleModule_GetRecentlyUpdatedPeopleIds_Paging_Only_HasNextPage()
        {
            var startDate = TestUtility.EncodeForURL(START_DATE.ToTraktCacheEfficientLongDateTimeString());
        ...
        [Fact]
        public async Task Test_TraktPeopleModule_GetRecentlyUpdatedPeopleIds_Paging_Not_HasPreviousPage_Or_HasNextPage()
        {
            var startDate = TestUtility.EncodeForURL(START_DATE.ToTraktCacheEfficientLongDateTimeString());
        ...
        [Fact]
        public async Task Test_TraktPeopleModule_GetRecentlyUpdatedPeopleIds_Paging_GetPreviousPage()
        {
            var startDate = TestUtility.EncodeForURL(START_DATE.ToTraktCacheEfficientLongDateTimeString());
        ...
        [Fact]
        public async Task Test_TraktPeopleModule_GetRecentlyUpdatedPeopleIds_Paging_GetNextPage()
        {
            var startDate = TestUtility.EncodeForURL(START_DATE.ToTraktCacheEfficientLongDateTimeString());
