namespace TraktNet.Modules.Tests.TraktSearchModule
{
    ...
    public partial class TraktSearchModule_Tests
    {
        ...
        [Fact]
        public async Task Test_TraktSearchModule_GetTextQueryResults_Paging_HasPreviousPage_And_HasNextPage()
        {
            TraktClient client = TestUtility.GetMockClient(
                $"{GetTextQueryUri}&fields={TEXT_QUERY_SEARCH_FIELD_TITLE.UriName}&{FILTER}&extended={EXTENDED_INFO}&page=2&limit={LIMIT}",
                SEARCH_TEXT_QUERY_RESULTS_JSON, 2, LIMIT, 5, TEXT_QUERY_ITEM_COUNT);
        ...
        [Fact]
        public async Task Test_TraktSearchModule_GetTextQueryResults_Paging_Only_HasPreviousPage()
        {
            TraktClient client = TestUtility.GetMockClient(
                $"{GetTextQueryUri}&fields={TEXT_QUERY_SEARCH_FIELD_TITLE.UriName}&{FILTER}&extended={EXTENDED_INFO}&page=2&limit={LIMIT}",
        ...
        [Fact]
        public async Task Test_TraktSearchModule_GetTextQueryResults_Paging_Only_HasNextPage()
        {
            TraktClient client = TestUtility.GetMockClient(
        ...
        [Fact]
        public async Task Test_TraktSearchModule_GetTextQueryResults_Paging_Not_HasPreviousPage_Or_HasNextPage()
        {
            TraktClient client = TestUtility.GetMockClient(
                $"{GetTextQueryUri}&fields={TEXT_QUERY_SEARCH_FIELD_TITLE.UriName}&{FILTER}&extended={EXTENDED_INFO}&page=1&limit={LIMIT}",
                SEARCH_TEXT_QUERY_RESULTS_JSON, 1, LIMIT, 1, TEXT_QUERY_ITEM_COUNT);
        ...
        [Fact]
        public async Task Test_TraktSearchModule_GetTextQueryResults_Paging_GetPreviousPage()
        {
            TraktClient client = TestUtility.GetMockClient(
                $"{GetTextQueryUri}&fields={TEXT_QUERY_SEARCH_FIELD_TITLE.UriName}&{FILTER}&extended={EXTENDED_INFO}&page=2&limit={LIMIT}",
                SEARCH_TEXT_QUERY_RESULTS_JSON, 2, LIMIT, 2, TEXT_QUERY_ITEM_COUNT);
        ...
        [Fact]
        public async Task Test_TraktSearchModule_GetTextQueryResults_Paging_GetNextPage()
        {
            TraktClient client = TestUtility.GetMockClient(
                $"{GetTextQueryUri}&fields={TEXT_QUERY_SEARCH_FIELD_TITLE.UriName}&{FILTER}&extended={EXTENDED_INFO}&page=1&limit={LIMIT}",
                SEARCH_TEXT_QUERY_RESULTS_JSON, 1, LIMIT, 2, TEXT_QUERY_ITEM_COUNT);
