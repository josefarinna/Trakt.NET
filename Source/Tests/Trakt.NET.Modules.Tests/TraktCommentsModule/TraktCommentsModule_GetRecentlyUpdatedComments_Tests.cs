namespace TraktNet.Modules.Tests.TraktCommentsModule
{
    ...
    public partial class TraktCommentsModule_Tests
    {
        ...
        [Fact]
        public async Task Test_TraktCommentsModule_GetRecentlyUpdatedComments_Paging_HasPreviousPage_And_HasNextPage()
        {
            TraktClient client = TestUtility.GetMockClient(
                $"{GET_COMMENTS_UPDATES_URI}/{COMMENT_TYPE.UriName}/{OBJECT_TYPE.UriName}" +
        ...
        [Fact]
        public async Task Test_TraktCommentsModule_GetRecentlyUpdatedComments_Paging_Only_HasPreviousPage()
        {
            TraktClient client = TestUtility.GetMockClient(
                $"{GET_COMMENTS_UPDATES_URI}/{COMMENT_TYPE.UriName}/{OBJECT_TYPE.UriName}" +
                $"?include_replies=true&extended={EXTENDED_INFO}&page=2&limit={LIMIT}",
        ...
        [Fact]
        public async Task Test_TraktCommentsModule_GetRecentlyUpdatedComments_Paging_Only_HasNextPage()
        {
            TraktClient client = TestUtility.GetMockClient(
                $"{GET_COMMENTS_UPDATES_URI}/{COMMENT_TYPE.UriName}/{OBJECT_TYPE.UriName}" +
        ...
        [Fact]
        public async Task Test_TraktCommentsModule_GetRecentlyUpdatedComments_Paging_Not_HasPreviousPage_Or_HasNextPage()
        {
            TraktClient client = TestUtility.GetMockClient(
                $"{GET_COMMENTS_UPDATES_URI}/{COMMENT_TYPE.UriName}/{OBJECT_TYPE.UriName}" +
                $"?include_replies=true&extended={EXTENDED_INFO}&page=1&limit={LIMIT}",
        ...
        [Fact]
        public async Task Test_TraktCommentsModule_GetRecentlyUpdatedComments_Paging_GetPreviousPage()
        {
            TraktClient client = TestUtility.GetMockClient(
                $"{GET_COMMENTS_UPDATES_URI}/{COMMENT_TYPE.UriName}/{OBJECT_TYPE.UriName}" +
                $"?include_replies=true&extended={EXTENDED_INFO}&page=2&limit={LIMIT}",
        ...
        [Fact]
        public async Task Test_TraktCommentsModule_GetRecentlyUpdatedComments_Paging_GetNextPage()
        {
            TraktClient client = TestUtility.GetMockClient(
                $"{GET_COMMENTS_UPDATES_URI}/{COMMENT_TYPE.UriName}/{OBJECT_TYPE.UriName}" +
                $"?include_replies=true&extended={EXTENDED_INFO}&page=1&limit={LIMIT}",
