namespace TraktNet.Modules.Tests.TraktCommentsModule
{
    ...
    public partial class TraktCommentsModule_Tests
    {
        ...
        public async Task Test_TraktCommentsModule_GetRecentlyCreatedComments_With_CommentType_And_ObjectType_And_Page()
        {
            ...
            TraktPagedResponse<ITraktUserComment> response =
                await client.Comments.GetRecentlyCreatedCommentsAsync(COMMENT_TYPE, OBJECT_TYPE, null, null, pagedParameters, TestContext.Current.CancellationToken);
        ...
        public async Task Test_TraktCommentsModule_GetRecentlyCreatedComments_With_CommentType_And_IncludeReplies_And_Page()
        {
            ...
            TraktPagedResponse<ITraktUserComment> response =
                await client.Comments.GetRecentlyCreatedCommentsAsync(COMMENT_TYPE, null, true, null, pagedParameters, TestContext.Current.CancellationToken);
        ...
        public async Task Test_TraktCommentsModule_GetRecentlyCreatedComments_With_CommentType_And_ExtendedInfo_And_Page()
        {
            ...
            TraktPagedResponse<ITraktUserComment> response =
                await client.Comments.GetRecentlyCreatedCommentsAsync(COMMENT_TYPE, null, null, EXTENDED_INFO, pagedParameters, TestContext.Current.CancellationToken);
        ...
        public async Task Test_TraktCommentsModule_GetRecentlyCreatedComments_With_CommentType_And_Page()
        {
            ...
            TraktPagedResponse<ITraktUserComment> response =
                await client.Comments.GetRecentlyCreatedCommentsAsync(COMMENT_TYPE, null, null, null, pagedParameters, TestContext.Current.CancellationToken);
        ...
        public async Task Test_TraktCommentsModule_GetRecentlyCreatedComments_With_ObjectType_And_IncludeReplies_And_Page()
        {
            ...
            TraktPagedResponse<ITraktUserComment> response =
                await client.Comments.GetRecentlyCreatedCommentsAsync(null, OBJECT_TYPE, true, null, pagedParameters, TestContext.Current.CancellationToken);
        ...
        public async Task Test_TraktCommentsModule_GetRecentlyCreatedComments_With_ObjectType_And_ExtendedInfo_And_Page()
        {
            ...
            TraktPagedResponse<ITraktUserComment> response =
                await client.Comments.GetRecentlyCreatedCommentsAsync(null, OBJECT_TYPE, null, EXTENDED_INFO, pagedParameters, TestContext.Current.CancellationToken);
        ...
        public async Task Test_TraktCommentsModule_GetRecentlyCreatedComments_With_ObjectType_And_Page()
        {
            ...
            TraktPagedResponse<ITraktUserComment> response =
                await client.Comments.GetRecentlyCreatedCommentsAsync(null, OBJECT_TYPE, null, null, pagedParameters, TestContext.Current.CancellationToken);
        ...
        public async Task Test_TraktCommentsModule_GetRecentlyCreatedComments_With_IncludeReplies_And_Page()
        {
            ...
            TraktPagedResponse<ITraktUserComment> response =
                await client.Comments.GetRecentlyCreatedCommentsAsync(null, null, true, null, pagedParameters, TestContext.Current.CancellationToken);
        ...
        public async Task Test_TraktCommentsModule_GetRecentlyCreatedComments_With_ExtendedInfo_And_Page()
        {
            ...
            TraktPagedResponse<ITraktUserComment> response =
                await client.Comments.GetRecentlyCreatedCommentsAsync(null, null, null, EXTENDED_INFO, pagedParameters, TestContext.Current.CancellationToken);
        ...
        public async Task Test_TraktCommentsModule_GetRecentlyCreatedComments_With_Page()
        {
            ...
            TraktPagedResponse<ITraktUserComment> response =
                await client.Comments.GetRecentlyCreatedCommentsAsync(null, null, null, null, pagedParameters, TestContext.Current.CancellationToken);
        ...
        public async Task Test_TraktCommentsModule_GetRecentlyCreatedComments_Paging_HasPreviousPage_And_HasNextPage()
        {
            ...
            TraktPagedResponse<ITraktUserComment> response =
                await client.Comments.GetRecentlyCreatedCommentsAsync(COMMENT_TYPE, OBJECT_TYPE, true, EXTENDED_INFO, pagedParameters, TestContext.Current.CancellationToken);
