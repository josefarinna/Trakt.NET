namespace TraktNet.Modules.Tests.TraktCommentsModule
{
    ...
    public partial class TraktCommentsModule_Tests
    {
        ...
        public async Task Test_TraktCommentsModule_GetCommentLikes()
        {
            ...
            TraktPagedResponse<ITraktCommentLike> response = await client.Comments.GetCommentLikesAsync(GET_COMMENT_ID, cancellationToken: TestContext.Current.CancellationToken);
        ...
        public async Task Test_TraktCommentsModule_GetCommentLikes_With_ExtendedInfo()
        {
            ...
            TraktPagedResponse<ITraktCommentLike> response = await client.Comments.GetCommentLikesAsync(GET_COMMENT_ID, EXTENDED_INFO, cancellationToken: TestContext.Current.CancellationToken);
        ...
        public async Task Test_TraktCommentsModule_GetCommentLikes_With_Page()
        {
            ...
            TraktPagedResponse<ITraktCommentLike> response = await client.Comments.GetCommentLikesAsync(GET_COMMENT_ID, null, pagedParameters, TestContext.Current.CancellationToken);
        ...
        public async Task Test_TraktCommentsModule_GetCommentLikes_With_ExtendedInfo_And_Page()
        {
            ...
            var pagedParameters = new TraktPagedParameters(PAGE);
            TraktPagedResponse<ITraktCommentLike> response = await client.Comments.GetCommentLikesAsync(GET_COMMENT_ID, EXTENDED_INFO, pagedParameters, TestContext.Current.CancellationToken);
        ...
        [Fact]
        public async Task Test_TraktCommentsModule_GetCommentLikes_Paging_HasPreviousPage_And_HasNextPage()
        {
            TraktClient client = TestUtility.GetMockClient($"{GET_COMMENT_LIKES_URI}?page=2&limit={LIMIT}",
                                                           COMMENT_LIKES_JSON, 2, LIMIT, 5, ITEM_COUNT);
        ...
        [Fact]
        public async Task Test_TraktCommentsModule_GetCommentLikes_Paging_Only_HasPreviousPage()
        {
            TraktClient client = TestUtility.GetMockClient($"{GET_COMMENT_LIKES_URI}?page=2&limit={LIMIT}",
                                                           COMMENT_LIKES_JSON, 2, LIMIT, 2, ITEM_COUNT);
        ...
        [Fact]
        public async Task Test_TraktCommentsModule_GetCommentLikes_Paging_Only_HasNextPage()
        {
            TraktClient client = TestUtility.GetMockClient($"{GET_COMMENT_LIKES_URI}?page=1&limit={LIMIT}",
                                                           COMMENT_LIKES_JSON, 1, LIMIT, 2, ITEM_COUNT);
        ...
        [Fact]
        public async Task Test_TraktCommentsModule_GetCommentLikes_Paging_Not_HasPreviousPage_Or_HasNextPage()
        {
            TraktClient client = TestUtility.GetMockClient($"{GET_COMMENT_LIKES_URI}?page=1&limit={LIMIT}",
                                                           COMMENT_LIKES_JSON, 1, LIMIT, 1, ITEM_COUNT);
        ...
        [Fact]
        public async Task Test_TraktCommentsModule_GetCommentLikes_Paging_GetPreviousPage()
        {
            TraktClient client = TestUtility.GetMockClient($"{GET_COMMENT_LIKES_URI}?page=2&limit={LIMIT}",
                                                           COMMENT_LIKES_JSON, 2, LIMIT, 2, ITEM_COUNT);
            ...
            TestUtility.ResetMockClient(client, $"{GET_COMMENT_LIKES_URI}?page=1&limit={LIMIT}",
                                        COMMENT_LIKES_JSON, 1, LIMIT, 2, ITEM_COUNT);
        ...
        [Fact]
        public async Task Test_TraktCommentsModule_GetCommentLikes_Paging_GetNextPage()
        {
            TraktClient client = TestUtility.GetMockClient($"{GET_COMMENT_LIKES_URI}?page=1&limit={LIMIT}",
                                                           COMMENT_LIKES_JSON, 1, LIMIT, 2, ITEM_COUNT);
            ...
            TestUtility.ResetMockClient(client, $"{GET_COMMENT_LIKES_URI}?page=2&limit={LIMIT}",
                                        COMMENT_LIKES_JSON, 2, LIMIT, 2, ITEM_COUNT);
        ...
        public async Task Test_TraktCommentsModule_GetCommentLikes_Throws_API_Exception(HttpStatusCode statusCode, Type exceptionType)
        {
            ...
            try
            {
                await client.Comments.GetCommentLikesAsync(GET_COMMENT_ID, cancellationToken: TestContext.Current.CancellationToken);
                Assert.False(true);
            }
