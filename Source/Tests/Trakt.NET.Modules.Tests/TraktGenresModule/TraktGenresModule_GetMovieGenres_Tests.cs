namespace TraktNet.Modules.Tests.TraktGenresModule
{
    ...
    public partial class TraktGenresModule_Tests
    {
        ...
        public async Task Test_TraktGenresModule_GetMovieGenres()
        {
            ...
            TraktListResponse<ITraktGenre> response = await client.Genres.GetMovieGenresAsync();
        ...
        public async Task Test_TraktGenresModule_GetMovieGenres_Throws_API_Exception(HttpStatusCode statusCode, Type exceptionType)
        {
            TraktClient client = TestUtility.GetMockClient(GENRES_MOVIES_URI, statusCode);

            try
            {
                await client.Genres.GetMovieGenresAsync();
                Assert.False(true);
            }
