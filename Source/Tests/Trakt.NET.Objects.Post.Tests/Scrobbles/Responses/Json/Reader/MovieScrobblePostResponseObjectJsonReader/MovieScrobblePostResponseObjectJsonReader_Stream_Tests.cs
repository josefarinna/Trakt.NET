namespace TraktNet.Objects.Post.Tests.Scrobbles.Responses.Json.Reader
{
    ...
    public partial class MovieScrobblePostResponseObjectJsonReader_Tests
    {
        ...
        [Fact]
        public async Task Test_MovieScrobblePostResponseObjectJsonReader_ReadObject_From_Stream_Incomplete_1()
        {
            var jsonReader = new MovieScrobblePostResponseObjectJsonReader();
        ...
        [Fact]
        public async Task Test_MovieScrobblePostResponseObjectJsonReader_ReadObject_From_Stream_Incomplete_2()
        {
            var jsonReader = new MovieScrobblePostResponseObjectJsonReader();
        ...
        [Fact]
        public async Task Test_MovieScrobblePostResponseObjectJsonReader_ReadObject_From_Stream_Incomplete_4()
        {
            var jsonReader = new MovieScrobblePostResponseObjectJsonReader();
        ...
        [Fact]
        public async Task Test_MovieScrobblePostResponseObjectJsonReader_ReadObject_From_Stream_Incomplete_5()
        {
            var jsonReader = new MovieScrobblePostResponseObjectJsonReader();
        ...
        [Fact]
        public async Task Test_MovieScrobblePostResponseObjectJsonReader_ReadObject_From_Stream_Incomplete_6()
        {
            var jsonReader = new MovieScrobblePostResponseObjectJsonReader();
        ...
        [Fact]
        public async Task Test_MovieScrobblePostResponseObjectJsonReader_ReadObject_From_Stream_Incomplete_9()
        {
            var jsonReader = new MovieScrobblePostResponseObjectJsonReader();
        ...
        [Fact]
        public async Task Test_MovieScrobblePostResponseObjectJsonReader_ReadObject_From_Stream_Not_Valid_2()
        {
            var jsonReader = new MovieScrobblePostResponseObjectJsonReader();
        ...
        [Fact]
        public async Task Test_MovieScrobblePostResponseObjectJsonReader_ReadObject_From_Stream_Not_Valid_4()
        {
            var jsonReader = new MovieScrobblePostResponseObjectJsonReader();
        ...
        [Fact]
        public async Task Test_MovieScrobblePostResponseObjectJsonReader_ReadObject_From_Stream_Not_Valid_5()
        {
            var jsonReader = new MovieScrobblePostResponseObjectJsonReader();
        ...
        [Fact]
        public async Task Test_MovieScrobblePostResponseObjectJsonReader_ReadObject_From_Stream_Null()
        {
            var jsonReader = new MovieScrobblePostResponseObjectJsonReader();
            Func<Task<ITraktMovieScrobblePostResponse>> movieScrobbleResponse = () => jsonReader.ReadObjectAsync(default(Stream));
            await movieScrobbleResponse.Should().ThrowAsync<ArgumentNullException>();
        }

        [Fact]
        public async Task Test_MovieScrobblePostResponseObjectJsonReader_ReadObject_From_Stream_Empty()
        {
            var jsonReader = new MovieScrobblePostResponseObjectJsonReader();
