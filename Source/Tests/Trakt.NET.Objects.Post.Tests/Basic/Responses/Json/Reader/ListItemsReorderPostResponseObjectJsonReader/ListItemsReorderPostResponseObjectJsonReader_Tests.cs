namespace TraktNet.Objects.Post.Tests.Basic.Responses.Json.Reader
{
    ...
    public partial class ListItemsReorderPostResponseObjectJsonReader_Tests
    {
        ...
        [Fact]
        public async Task Test_ListItemsReorderPostResponseObjectJsonReader_ReadObject_From_JsonReader_Incomplete_3()
        {
            var traktJsonReader = new ListItemsReorderPostResponseObjectJsonReader();
        ...
        [Fact]
        public async Task Test_ListItemsReorderPostResponseObjectJsonReader_ReadObject_From_JsonReader_Not_Valid_4()
        {
            var traktJsonReader = new ListItemsReorderPostResponseObjectJsonReader();
