namespace TraktNet.Objects.Post.Tests.Users.PersonalListItems.Responses.Json.Reader
{
    ...
    {
        [Fact]
        public async Task Test_UserPersonalListItemsPostResponseObjectJsonReader_ReadObject_From_JsonReader_Complete()
        {
            var traktJsonReader = new UserPersonalListItemsPostResponseObjectJsonReader();

            using (var reader = new StringReader(JSON_COMPLETE))
            using (var jsonReader = new JsonTextReader(reader))
            {
                var personalListItemsPostResponse = await traktJsonReader.ReadObjectAsync(jsonReader);
        ...
        [Fact]
        public async Task Test_UserPersonalListItemsPostResponseObjectJsonReader_ReadObject_From_JsonReader_Incomplete_1()
        {
            var traktJsonReader = new UserPersonalListItemsPostResponseObjectJsonReader();
        ...
        [Fact]
        public async Task Test_UserPersonalListItemsPostResponseObjectJsonReader_ReadObject_From_JsonReader_Incomplete_2()
        {
            var traktJsonReader = new UserPersonalListItemsPostResponseObjectJsonReader();
        ...
        [Fact]
        public async Task Test_UserPersonalListItemsPostResponseObjectJsonReader_ReadObject_From_JsonReader_Incomplete_3()
        {
            var traktJsonReader = new UserPersonalListItemsPostResponseObjectJsonReader();
        ...
        [Fact]
        public async Task Test_UserPersonalListItemsPostResponseObjectJsonReader_ReadObject_From_JsonReader_Incomplete_4()
        {
            var traktJsonReader = new UserPersonalListItemsPostResponseObjectJsonReader();
        ...
        [Fact]
        public async Task Test_UserPersonalListItemsPostResponseObjectJsonReader_ReadObject_From_JsonReader_Incomplete_5()
        {
            var traktJsonReader = new UserPersonalListItemsPostResponseObjectJsonReader();
        ...
        [Fact]
        public async Task Test_UserPersonalListItemsPostResponseObjectJsonReader_ReadObject_From_JsonReader_Incomplete_6()
        {
            var traktJsonReader = new UserPersonalListItemsPostResponseObjectJsonReader();
        ...
        [Fact]
        public async Task Test_UserPersonalListItemsPostResponseObjectJsonReader_ReadObject_From_JsonReader_Not_Valid_1()
        {
            var traktJsonReader = new UserPersonalListItemsPostResponseObjectJsonReader();
        ...
        [Fact]
        public async Task Test_UserPersonalListItemsPostResponseObjectJsonReader_ReadObject_From_JsonReader_Not_Valid_2()
        {
            var traktJsonReader = new UserPersonalListItemsPostResponseObjectJsonReader();
        ...
        [Fact]
        public async Task Test_UserPersonalListItemsPostResponseObjectJsonReader_ReadObject_From_JsonReader_Not_Valid_3()
        {
            var traktJsonReader = new UserPersonalListItemsPostResponseObjectJsonReader();
        ...
        [Fact]
        public async Task Test_UserPersonalListItemsPostResponseObjectJsonReader_ReadObject_From_JsonReader_Not_Valid_4()
        {
            var traktJsonReader = new UserPersonalListItemsPostResponseObjectJsonReader();
        ...
        [Fact]
        public async Task Test_UserPersonalListItemsPostResponseObjectJsonReader_ReadObject_From_JsonReader_Null()
        {
            var traktJsonReader = new UserPersonalListItemsPostResponseObjectJsonReader();
            Func<Task<ITraktUserPersonalListItemsPostResponse>> personalListItemsPostResponse = () => traktJsonReader.ReadObjectAsync(default(JsonTextReader));
            await personalListItemsPostResponse.Should().ThrowAsync<ArgumentNullException>();
        }

        [Fact]
        public async Task Test_UserPersonalListItemsPostResponseObjectJsonReader_ReadObject_From_JsonReader_Empty()
        {
            var traktJsonReader = new UserPersonalListItemsPostResponseObjectJsonReader();
