namespace TraktNet.Objects.Post.Tests.Users.PersonalListItems.Responses.Json.Reader
{
    ...
    {
        [Fact]
        public async Task Test_UserPersonalListItemsRemovePostResponseObjectJsonReader_ReadObject_From_Json_String_Complete()
        {
            var jsonReader = new UserPersonalListItemsRemovePostResponseObjectJsonReader();

            var personalListItemsRemovePostResponse = await jsonReader.ReadObjectAsync(JSON_COMPLETE);
        ...
        [Fact]
        public async Task Test_UserPersonalListItemsRemovePostResponseObjectJsonReader_ReadObject_From_Json_String_Incomplete_1()
        {
            var jsonReader = new UserPersonalListItemsRemovePostResponseObjectJsonReader();

            var personalListItemsRemovePostResponse = await jsonReader.ReadObjectAsync(JSON_INCOMPLETE_1);
        ...
        [Fact]
        public async Task Test_UserPersonalListItemsRemovePostResponseObjectJsonReader_ReadObject_From_Json_String_Incomplete_2()
        {
            var jsonReader = new UserPersonalListItemsRemovePostResponseObjectJsonReader();

            var personalListItemsRemovePostResponse = await jsonReader.ReadObjectAsync(JSON_INCOMPLETE_2);
        ...
        [Fact]
        public async Task Test_UserPersonalListItemsRemovePostResponseObjectJsonReader_ReadObject_From_Json_String_Not_Valid_1()
        {
            var jsonReader = new UserPersonalListItemsRemovePostResponseObjectJsonReader();

            var personalListItemsRemovePostResponse = await jsonReader.ReadObjectAsync(JSON_NOT_VALID_1);
        ...
        [Fact]
        public async Task Test_UserPersonalListItemsRemovePostResponseObjectJsonReader_ReadObject_From_Json_String_Not_Valid_2()
        {
            var jsonReader = new UserPersonalListItemsRemovePostResponseObjectJsonReader();

            var personalListItemsRemovePostResponse = await jsonReader.ReadObjectAsync(JSON_NOT_VALID_2);
        ...
        [Fact]
        public async Task Test_UserPersonalListItemsRemovePostResponseObjectJsonReader_ReadObject_From_Json_String_Not_Valid_3()
        {
            var jsonReader = new UserPersonalListItemsRemovePostResponseObjectJsonReader();

            var personalListItemsRemovePostResponse = await jsonReader.ReadObjectAsync(JSON_NOT_VALID_3);
        ...
        [Fact]
        public async Task Test_UserPersonalListItemsRemovePostResponseObjectJsonReader_ReadObject_From_Json_String_Null()
        {
            var jsonReader = new UserPersonalListItemsRemovePostResponseObjectJsonReader();
            Func<Task<ITraktUserPersonalListItemsRemovePostResponse>> personalListItemsRemovePostResponse = () => jsonReader.ReadObjectAsync(default(string));
            await personalListItemsRemovePostResponse.Should().ThrowAsync<ArgumentNullException>();
        }

        [Fact]
        public async Task Test_UserPersonalListItemsRemovePostResponseObjectJsonReader_ReadObject_From_Json_String_Empty()
        {
            var jsonReader = new UserPersonalListItemsRemovePostResponseObjectJsonReader();

            var personalListItemsRemovePostResponse = await jsonReader.ReadObjectAsync(string.Empty);
