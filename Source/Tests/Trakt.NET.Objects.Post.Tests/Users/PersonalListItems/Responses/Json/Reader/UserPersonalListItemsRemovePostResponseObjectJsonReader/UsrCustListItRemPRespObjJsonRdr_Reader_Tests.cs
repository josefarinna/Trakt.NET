namespace TraktNet.Objects.Post.Tests.Users.PersonalListItems.Responses.Json.Reader
{
    ...
    {
        [Fact]
        public async Task Test_UserPersonalListItemsRemovePostResponseObjectJsonReader_ReadObject_From_JsonReader_Complete()
        {
            var traktJsonReader = new UserPersonalListItemsRemovePostResponseObjectJsonReader();

            using (var reader = new StringReader(JSON_COMPLETE))
            using (var jsonReader = new JsonTextReader(reader))
            {
                var personalListItemsRemovePostResponse = await traktJsonReader.ReadObjectAsync(jsonReader);
        ...
        [Fact]
        public async Task Test_UserPersonalListItemsRemovePostResponseObjectJsonReader_ReadObject_From_JsonReader_Incomplete_1()
        {
            var traktJsonReader = new UserPersonalListItemsRemovePostResponseObjectJsonReader();
        ...
        [Fact]
        public async Task Test_UserPersonalListItemsRemovePostResponseObjectJsonReader_ReadObject_From_JsonReader_Incomplete_2()
        {
            var traktJsonReader = new UserPersonalListItemsRemovePostResponseObjectJsonReader();
        ...
        [Fact]
        public async Task Test_UserPersonalListItemsRemovePostResponseObjectJsonReader_ReadObject_From_JsonReader_Not_Valid_1()
        {
            var traktJsonReader = new UserPersonalListItemsRemovePostResponseObjectJsonReader();
        ...
        [Fact]
        public async Task Test_UserPersonalListItemsRemovePostResponseObjectJsonReader_ReadObject_From_JsonReader_Not_Valid_2()
        {
            var traktJsonReader = new UserPersonalListItemsRemovePostResponseObjectJsonReader();
        ...
        [Fact]
        public async Task Test_UserPersonalListItemsRemovePostResponseObjectJsonReader_ReadObject_From_JsonReader_Not_Valid_3()
        {
            var traktJsonReader = new UserPersonalListItemsRemovePostResponseObjectJsonReader();
        ...
        [Fact]
        public async Task Test_UserPersonalListItemsRemovePostResponseObjectJsonReader_ReadObject_From_JsonReader_Null()
        {
            var traktJsonReader = new UserPersonalListItemsRemovePostResponseObjectJsonReader();
            Func<Task<ITraktUserPersonalListItemsRemovePostResponse>> personalListItemsRemovePostResponse = () => traktJsonReader.ReadObjectAsync(default(JsonTextReader));
            await personalListItemsRemovePostResponse.Should().ThrowAsync<ArgumentNullException>();
        }

        [Fact]
        public async Task Test_UserPersonalListItemsRemovePostResponseObjectJsonReader_ReadObject_From_JsonReader_Empty()
        {
            var traktJsonReader = new UserPersonalListItemsRemovePostResponseObjectJsonReader();
