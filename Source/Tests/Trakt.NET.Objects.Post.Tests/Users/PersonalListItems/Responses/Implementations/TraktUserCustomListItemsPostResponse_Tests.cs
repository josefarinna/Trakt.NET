namespace TraktNet.Objects.Post.Tests.Users.PersonalListItems.Responses.Implementations
{
    ...
    public class TraktUserPersonalListItemsPostResponse_Tests
    {
        [Fact]
        public void Test_TraktUserPersonalListItemsPostResponse_Default_Constructor()
        {
        ...
        [Fact]
        public async Task Test_TraktUserPersonalListItemsPostResponse_From_Json()
        {
            var jsonReader = new UserPersonalListItemsPostResponseObjectJsonReader();
            var personalListItemsPostResponse = await jsonReader.ReadObjectAsync(JSON) as TraktUserPersonalListItemsPostResponse;
