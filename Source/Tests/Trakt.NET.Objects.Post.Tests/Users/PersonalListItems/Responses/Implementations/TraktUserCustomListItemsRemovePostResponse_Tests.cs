namespace TraktNet.Objects.Post.Tests.Users.PersonalListItems.Responses.Implementations
{
    ...
    public class TraktUserPersonalListItemsRemovePostResponse_Tests
    {
        [Fact]
        public void Test_TraktUserPersonalListItemsRemovePostResponse_Default_Constructor()
        {
        ...
        [Fact]
        public async Task Test_TraktUserPersonalListItemsRemovePostResponse_From_Json()
        {
            var jsonReader = new UserPersonalListItemsRemovePostResponseObjectJsonReader();
            var personalListItemsRemovePostResponse = await jsonReader.ReadObjectAsync(JSON) as TraktUserPersonalListItemsRemovePostResponse;
