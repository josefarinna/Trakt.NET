namespace TraktNet.Objects.Post.Tests.Users.PersonalListItems.Responses.Implementations
{
    ...
    public class TraktUserPersonalListItemsPostResponseNotFoundGroup_Tests
    {
        [Fact]
        public void Test_TraktUserPersonalListItemsPostResponseNotFoundGroup_Default_Constructor()
        {
        ...
        [Fact]
        public async Task Test_TraktUserPersonalListItemsPostResponseNotFoundGroup_From_Json()
        {
            var jsonReader = new UserPersonalListItemsPostResponseNotFoundGroupObjectJsonReader();
            var personalListItemsPostResponseNotFoundGroup = await jsonReader.ReadObjectAsync(JSON) as TraktUserPersonalListItemsPostResponseNotFoundGroup;
