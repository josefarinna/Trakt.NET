namespace TraktNet.Objects.Post.Tests.Users.Responses.Json.Reader
{
    ...
    {
        [Fact]
        public async Task Test_UserFollowUserPostResponseObjectJsonReader_ReadObject_From_JsonReader_Complete()
        {
            var traktJsonReader = new UserFollowUserPostResponseObjectJsonReader();
        ...
        [Fact]
        public async Task Test_UserFollowUserPostResponseObjectJsonReader_ReadObject_From_JsonReader_Incomplete_1()
        {
            var traktJsonReader = new UserFollowUserPostResponseObjectJsonReader();
        ...
        [Fact]
        public async Task Test_UserFollowUserPostResponseObjectJsonReader_ReadObject_From_JsonReader_Incomplete_2()
        {
            var traktJsonReader = new UserFollowUserPostResponseObjectJsonReader();
        ...
        [Fact]
        public async Task Test_UserFollowUserPostResponseObjectJsonReader_ReadObject_From_JsonReader_Not_Valid_1()
        {
            var traktJsonReader = new UserFollowUserPostResponseObjectJsonReader();
        ...
        [Fact]
        public async Task Test_UserFollowUserPostResponseObjectJsonReader_ReadObject_From_JsonReader_Not_Valid_2()
        {
            var traktJsonReader = new UserFollowUserPostResponseObjectJsonReader();
        ...
        [Fact]
        public async Task Test_UserFollowUserPostResponseObjectJsonReader_ReadObject_From_JsonReader_Not_Valid_3()
        {
            var traktJsonReader = new UserFollowUserPostResponseObjectJsonReader();
        ...
        [Fact]
        public async Task Test_UserFollowUserPostResponseObjectJsonReader_ReadObject_From_JsonReader_Null()
        {
            var traktJsonReader = new UserFollowUserPostResponseObjectJsonReader();
            Func<Task<ITraktUserFollowUserPostResponse>> userFollowUserPostResponse = () => traktJsonReader.ReadObjectAsync(default(JsonTextReader));
            await userFollowUserPostResponse.Should().ThrowAsync<ArgumentNullException>();
        }

        [Fact]
        public async Task Test_UserFollowUserPostResponseObjectJsonReader_ReadObject_From_JsonReader_Empty()
        {
            var traktJsonReader = new UserFollowUserPostResponseObjectJsonReader();
