namespace TraktNet.Objects.Get.Tests.Shows.Implementations
{
    ...
    public class TraktMostPWCShow_Tests
    {
        ...
        public void Test_TraktMostPWCShow_Default_Constructor()
        {
            ...
            mostPWCShow.Tagline.Should().BeNullOrEmpty();
        ...
        public async Task Test_TraktMostPWCShow_From_Minimal_Json()
        {
            ...
            mostPWCShow.Show.Tagline.Should().BeNullOrEmpty();
        ...
        public async Task Test_TraktMostPWCShow_From_Full_Json()
        {
            ...
            mostPWCShow.Show.Tagline.Should().Be("Winter Is Coming");
            ...
            mostPWCShow.Tagline.Should().Be("Winter Is Coming");
