namespace TraktNet.Objects.Get.Tests.Shows.Implementations
{
    ...
    public class TraktMostAnticipatedShow_Tests
    {
        ...
        public void Test_TraktMostAnticipatedShow_Default_Constructor()
        {
            ...
            anticipatedShow.Tagline.Should().BeNullOrEmpty();
        ...
        public async Task Test_TraktMostAnticipatedShow_From_Minimal_Json()
        {
            ...
            anticipatedShow.Show.Tagline.Should().BeNullOrEmpty();
        ...
        public async Task Test_TraktMostAnticipatedShow_From_Full_Json()
        {
            ...
            anticipatedShow.Show.Tagline.Should().Be("Winter Is Coming");
            ...
            anticipatedShow.Tagline.Should().Be("Winter Is Coming");
