namespace TraktNet.Objects.Get.Tests.Shows.Json.Reader
{
    ...
    {
        [Fact]
        public async Task Test_ShowCastAndCrewObjectJsonReader_ReadObject_From_JsonReader_Complete()
        {
            ...
            {
                var traktShowCastAndCrew = await traktJsonReader.ReadObjectAsync(jsonReader);
