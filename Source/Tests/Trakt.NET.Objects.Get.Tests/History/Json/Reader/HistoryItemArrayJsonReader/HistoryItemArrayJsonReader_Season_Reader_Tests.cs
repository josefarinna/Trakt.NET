namespace TraktNet.Objects.Get.Tests.History.Json.Reader
{
    ...
    {
        [Fact]
        public async Task Test_HistoryItemArrayJsonReader_Season_Read_Array_From_JsonReader_Complete()
        {
        ...
        [Fact]
        public async Task Test_HistoryItemArrayJsonReader_Season_Read_Array_From_JsonReader_Incomplete_1()
        {
            var traktJsonReader = new ArrayJsonReader<ITraktHistoryItem>();
        ...
        [Fact]
        public async Task Test_HistoryItemArrayJsonReader_Season_Read_Array_From_JsonReader_Incomplete_2()
        {
            var traktJsonReader = new ArrayJsonReader<ITraktHistoryItem>();
        ...
        [Fact]
        public async Task Test_HistoryItemArrayJsonReader_Season_Read_Array_From_JsonReader_Not_Valid_1()
        {
            var traktJsonReader = new ArrayJsonReader<ITraktHistoryItem>();
        ...
        [Fact]
        public async Task Test_HistoryItemArrayJsonReader_Season_Read_Array_From_JsonReader_Not_Valid_2()
        {
            var traktJsonReader = new ArrayJsonReader<ITraktHistoryItem>();
        ...
        [Fact]
        public async Task Test_HistoryItemArrayJsonReader_Season_Read_Array_From_JsonReader_Not_Valid_3()
        {
            var traktJsonReader = new ArrayJsonReader<ITraktHistoryItem>();
