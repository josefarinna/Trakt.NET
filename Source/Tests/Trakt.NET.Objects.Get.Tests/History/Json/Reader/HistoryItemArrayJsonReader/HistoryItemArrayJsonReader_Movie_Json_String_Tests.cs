namespace TraktNet.Objects.Get.Tests.History.Json.Reader
{
    ...
    {
        [Fact]
        public async Task Test_HistoryItemArrayJsonReader_Movie_Read_Array_From_Json_String_Complete()
        {
            var jsonReader = new ArrayJsonReader<ITraktHistoryItem>();

            var traktHistoryItems = await jsonReader.ReadArrayAsync(TYPE_MOVIE_JSON_COMPLETE);
        ...
        [Fact]
        public async Task Test_HistoryItemArrayJsonReader_Movie_Read_Array_From_Json_String_Incomplete_2()
        {
            var jsonReader = new ArrayJsonReader<ITraktHistoryItem>();

            var traktHistoryItems = await jsonReader.ReadArrayAsync(TYPE_MOVIE_JSON_INCOMPLETE_2);
            traktHistoryItems.Should().NotBeNull().And.NotBeEmpty().And.HaveCount(2);
        ...
        [Fact]
        public async Task Test_HistoryItemArrayJsonReader_Movie_Read_Array_From_Json_String_Not_Valid_1()
        {
            var jsonReader = new ArrayJsonReader<ITraktHistoryItem>();

            var traktHistoryItems = await jsonReader.ReadArrayAsync(TYPE_MOVIE_JSON_NOT_VALID_1);
            traktHistoryItems.Should().NotBeNull().And.NotBeEmpty().And.HaveCount(2);
        ...
        [Fact]
        public async Task Test_HistoryItemArrayJsonReader_Movie_Read_Array_From_Json_String_Not_Valid_2()
        {
            var jsonReader = new ArrayJsonReader<ITraktHistoryItem>();

            var traktHistoryItems = await jsonReader.ReadArrayAsync(TYPE_MOVIE_JSON_NOT_VALID_2);
            traktHistoryItems.Should().NotBeNull().And.NotBeEmpty().And.HaveCount(2);
        ...
        [Fact]
        public async Task Test_HistoryItemArrayJsonReader_Movie_Read_Array_From_Json_String_Not_Valid_3()
        {
            var jsonReader = new ArrayJsonReader<ITraktHistoryItem>();

            var traktHistoryItems = await jsonReader.ReadArrayAsync(TYPE_MOVIE_JSON_NOT_VALID_3);
            traktHistoryItems.Should().NotBeNull().And.NotBeEmpty().And.HaveCount(2);
