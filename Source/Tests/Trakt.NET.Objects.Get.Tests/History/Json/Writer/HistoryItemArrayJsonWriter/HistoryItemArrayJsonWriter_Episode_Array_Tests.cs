namespace TraktNet.Objects.Get.Tests.History.Json.Writer
{
    ...
    {
        [Fact]
        public async Task Test_HistoryItemArrayJsonWriter_Episode_WriteArray_Array_SingleObject()
        {
        ...
        [Fact]
        public async Task Test_HistoryItemArrayJsonWriter_Episode_WriteArray_Array_Complete()
        {
            IEnumerable<ITraktHistoryItem> traktHistoryItems = new List<ITraktHistoryItem>
            {
                new TraktHistoryItem
