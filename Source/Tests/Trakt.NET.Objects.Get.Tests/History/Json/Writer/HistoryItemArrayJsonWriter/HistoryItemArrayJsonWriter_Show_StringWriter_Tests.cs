namespace TraktNet.Objects.Get.Tests.History.Json.Writer
{
    ...
    {
        [Fact]
        public async Task Test_HistoryItemArrayJsonWriter_Show_WriteArray_StringWriter_SingleObject()
        {
        ...
        [Fact]
        public async Task Test_HistoryItemArrayJsonWriter_Show_WriteArray_StringWriter_Complete()
        {
            IEnumerable<ITraktHistoryItem> traktHistoryItems = new List<ITraktHistoryItem>
            {
                new TraktHistoryItem
