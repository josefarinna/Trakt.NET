namespace TraktNet.Objects.Get.Tests.History.Json.Writer
{
    ...
    {
        [Fact]
        public async Task Test_HistoryItemObjectJsonWriter_Episode_WriteObject_StringWriter_Exceptions()
        {
        ...
        [Fact]
        public async Task Test_HistoryItemObjectJsonWriter_Episode_WriteObject_StringWriter_Complete()
        {
            ITraktHistoryItem traktHistoryItem = new TraktHistoryItem
            {
                Id = 1982347UL,
