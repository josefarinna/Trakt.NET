namespace TraktNet.Objects.Get.Tests.Watchlist.Json.Reader
{
    ...
    public partial class WatchlistItemObjectJsonReader_Movie_Tests
    {
        ...
        [Fact]
        public async Task Test_WatchlistItemObjectJsonReader_Movie_ReadObject_From_JsonReader_Not_Valid_5()
        {
            var traktJsonReader = new WatchlistItemObjectJsonReader();
        ...
        [Fact]
        public async Task Test_WatchlistItemObjectJsonReader_Movie_ReadObject_From_JsonReader_Not_Valid_6()
        {
            var traktJsonReader = new WatchlistItemObjectJsonReader();
