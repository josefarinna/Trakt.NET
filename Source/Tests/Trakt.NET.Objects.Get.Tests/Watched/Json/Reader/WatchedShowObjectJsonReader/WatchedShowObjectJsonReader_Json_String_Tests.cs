namespace TraktNet.Objects.Get.Tests.Watched.Json.Reader
{
    ...
    public partial class WatchedShowObjectJsonReader_Tests
    {
        ...
        [Fact]
        public async Task Test_WatchedShowObjectJsonReader_ReadObject_From_Json_String_Incomplete_9()
        {
            var jsonReader = new WatchedShowObjectJsonReader();

            var traktWatchedShow = await jsonReader.ReadObjectAsync(JSON_INCOMPLETE_9);
        ...
        [Fact]
        public async Task Test_WatchedShowObjectJsonReader_ReadObject_From_Json_String_Incomplete_10()
        {
            var jsonReader = new WatchedShowObjectJsonReader();

            var traktWatchedShow = await jsonReader.ReadObjectAsync(JSON_INCOMPLETE_10);
        ...
        [Fact]
        public async Task Test_WatchedShowObjectJsonReader_ReadObject_From_Json_String_Incomplete_11()
        {
            var jsonReader = new WatchedShowObjectJsonReader();

            var traktWatchedShow = await jsonReader.ReadObjectAsync(JSON_INCOMPLETE_11);
        ...
        [Fact]
        public async Task Test_WatchedShowObjectJsonReader_ReadObject_From_Json_String_Incomplete_12()
        {
            var jsonReader = new WatchedShowObjectJsonReader();

            var traktWatchedShow = await jsonReader.ReadObjectAsync(JSON_INCOMPLETE_12);
        ...
        [Fact]
        public async Task Test_WatchedShowObjectJsonReader_ReadObject_From_Json_String_Not_Valid_6()
        {
            var jsonReader = new WatchedShowObjectJsonReader();

            var traktWatchedShow = await jsonReader.ReadObjectAsync(JSON_NOT_VALID_6);
        ...
        [Fact]
        public async Task Test_WatchedShowObjectJsonReader_ReadObject_From_Json_String_Not_Valid_7()
        {
            var jsonReader = new WatchedShowObjectJsonReader();

            var traktWatchedShow = await jsonReader.ReadObjectAsync(JSON_NOT_VALID_7);
        ...
        {
            var jsonReader = new WatchedShowObjectJsonReader();
            Func<Task<ITraktWatchedShow>> traktWatchedShow = () => jsonReader.ReadObjectAsync(default(string));
