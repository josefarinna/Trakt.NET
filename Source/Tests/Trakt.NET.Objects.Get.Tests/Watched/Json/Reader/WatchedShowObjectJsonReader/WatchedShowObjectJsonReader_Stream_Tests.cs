namespace TraktNet.Objects.Get.Tests.Watched.Json.Reader
{
    ...
    public partial class WatchedShowObjectJsonReader_Tests
    {
        ...
        [Fact]
        public async Task Test_WatchedShowObjectJsonReader_ReadObject_From_Stream_Incomplete_9()
        {
            var jsonReader = new WatchedShowObjectJsonReader();
        ...
        [Fact]
        public async Task Test_WatchedShowObjectJsonReader_ReadObject_From_Stream_Incomplete_11()
        {
            var jsonReader = new WatchedShowObjectJsonReader();
        ...
        [Fact]
        public async Task Test_WatchedShowObjectJsonReader_ReadObject_From_Stream_Incomplete_12()
        {
            var jsonReader = new WatchedShowObjectJsonReader();
        ...
        [Fact]
        public async Task Test_WatchedShowObjectJsonReader_ReadObject_From_Stream_Not_Valid_7()
        {
            var jsonReader = new WatchedShowObjectJsonReader();
        ...
        {
            var jsonReader = new WatchedShowObjectJsonReader();
            Func<Task<ITraktWatchedShow>> traktWatchedShow = () => jsonReader.ReadObjectAsync(default(Stream));
