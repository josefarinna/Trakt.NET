namespace TraktNet.Objects.Get.Tests.Watched.Implementations
{
    ...
    public class TraktWatchedShow_Tests
    {
        ...
        public void Test_TraktWatchedShow_Default_Constructor()
        {
            ...
            watchedShow.Tagline.Should().BeNullOrEmpty();
        ...
        public async Task Test_TraktWatchedShow_From_Minimal_Json()
        {
            ...
            watchedShow.Show.Tagline.Should().BeNullOrEmpty();
        ...
        public async Task Test_TraktWatchedShow_From_Full_Json()
        {
            ...
            watchedShow.Show.Tagline.Should().Be("Winter Is Coming");
            ...
            watchedShow.Tagline.Should().Be("Winter Is Coming");
