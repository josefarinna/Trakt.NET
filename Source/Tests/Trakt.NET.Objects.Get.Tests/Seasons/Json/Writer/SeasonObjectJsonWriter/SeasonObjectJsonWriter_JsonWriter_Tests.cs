namespace TraktNet.Objects.Get.Tests.Seasons.Json.Writer
{
    ...
    public partial class SeasonObjectJsonWriter_Tests
    {
        ...
        [Fact]
        public async Task Test_SeasonObjectJsonWriter_WriteObject_JsonWriter_Only_Votes_Property()
        {
            ITraktSeason traktSeason = new TraktSeason
            {
                Votes = 9765
            ...
            using (var jsonWriter = new JsonTextWriter(stringWriter))
            {
                var traktJsonWriter = new SeasonObjectJsonWriter();
                await traktJsonWriter.WriteObjectAsync(jsonWriter, traktSeason);
                stringWriter.ToString().Should().Be(@"{""votes"":9765}");
            }
        }

        [Fact]
        public async Task Test_SeasonObjectJsonWriter_WriteObject_JsonWriter_Only_TotalEpisodesCount_Property()
        {
            ITraktSeason traktSeason = new TraktSeason
            {
            ...
            using (var jsonWriter = new JsonTextWriter(stringWriter))
            {
                var traktJsonWriter = new SeasonObjectJsonWriter();
                await traktJsonWriter.WriteObjectAsync(jsonWriter, traktSeason);
                stringWriter.ToString().Should().Be(@"{""episode_count"":24}");
            }
        }
        ...
        [Fact]
        public async Task Test_SeasonObjectJsonWriter_WriteObject_JsonWriter_Only_Overview_Property()
        {
            ITraktSeason traktSeason = new TraktSeason
            {
            ...
            using (var jsonWriter = new JsonTextWriter(stringWriter))
            {
                var traktJsonWriter = new SeasonObjectJsonWriter();
                await traktJsonWriter.WriteObjectAsync(jsonWriter, traktSeason);
                stringWriter.ToString().Should().Be(@"{""overview"":""Season 1 Overview""}");
            }
        }
        ...
        public async Task Test_SeasonObjectJsonWriter_WriteObject_JsonWriter_Only_Network_Property()
        {
            ...
            using (var jsonWriter = new JsonTextWriter(stringWriter))
            {
                var traktJsonWriter = new SeasonObjectJsonWriter();
                await traktJsonWriter.WriteObjectAsync(jsonWriter, traktSeason);
                stringWriter.ToString().Should().Be(@"{""network"":""Season 1 Network""}");
            }
        }
        ...
        [Fact]
        public async Task Test_SeasonObjectJsonWriter_WriteObject_JsonWriter_Complete()
        {
            ITraktSeason traktSeason = new TraktSeason
            {
                Number = 1,
