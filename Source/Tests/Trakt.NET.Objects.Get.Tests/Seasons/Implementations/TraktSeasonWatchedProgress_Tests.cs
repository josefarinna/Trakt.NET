namespace TraktNet.Objects.Get.Tests.Seasons.Implementations
{
    ...
    public class TraktSeasonWatchedProgress_Tests
    {
        ...
        public void Test_TraktSeasonWatchedProgress_Default_Constructor()
        {
            ...
            seasonWatchedProgress.Number.Should().BeNull();
            seasonWatchedProgress.Title.Should().BeNull();
            seasonWatchedProgress.Aired.Should().BeNull();
            seasonWatchedProgress.Completed.Should().BeNull();
        ...
        public async Task Test_TraktSeasonWatchedProgress_From_Json()
        {
            ...
            seasonWatchedProgress.Title.Should().Be("The first Hodor.");
