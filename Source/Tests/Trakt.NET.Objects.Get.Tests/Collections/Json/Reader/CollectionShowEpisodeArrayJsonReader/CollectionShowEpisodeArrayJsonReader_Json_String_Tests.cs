namespace TraktNet.Objects.Get.Tests.Collections.Json.Reader
{
    ...
    public partial class CollectionShowEpisodeArrayJsonReader_Tests
    {
        ...
        {
            var jsonReader = new ArrayJsonReader<ITraktCollectionShowEpisode>();
            Func<Task<IList<ITraktCollectionShowEpisode>>> traktCollectionShowEpisodes = () => jsonReader.ReadArrayAsync(default(string));
        ...
        public async Task Test_CollectionShowEpisodeArrayJsonReader_ReadArray_From_Json_String_Empty()
        {
            ...
            var traktCollectionShowEpisodes = await jsonReader.ReadArrayAsync(string.Empty);
