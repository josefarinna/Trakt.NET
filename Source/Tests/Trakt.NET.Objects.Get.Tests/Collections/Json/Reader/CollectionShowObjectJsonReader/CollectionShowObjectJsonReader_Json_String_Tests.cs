namespace TraktNet.Objects.Get.Tests.Collections.Json.Reader
{
    ...
    public partial class CollectionShowObjectJsonReader_Tests
    {
        ...
        [Fact]
        public async Task Test_CollectionShowObjectJsonReader_ReadObject_From_Json_String_Incomplete_7()
        {
            var jsonReader = new CollectionShowObjectJsonReader();

            var traktCollectionShow = await jsonReader.ReadObjectAsync(JSON_INCOMPLETE_7);
        ...
        [Fact]
        public async Task Test_CollectionShowObjectJsonReader_ReadObject_From_Json_String_Incomplete_8()
        {
            var jsonReader = new CollectionShowObjectJsonReader();

            var traktCollectionShow = await jsonReader.ReadObjectAsync(JSON_INCOMPLETE_8);
        ...
        [Fact]
        public async Task Test_CollectionShowObjectJsonReader_ReadObject_From_Json_String_Not_Valid_5()
        {
            var jsonReader = new CollectionShowObjectJsonReader();

            var traktCollectionShow = await jsonReader.ReadObjectAsync(JSON_NOT_VALID_5);
