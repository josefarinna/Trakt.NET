namespace TraktNet.Objects.Get.Tests.Collections.Json.Reader
{
    ...
    public partial class CollectionShowObjectJsonReader_Tests
    {
        ...
        [Fact]
        public async Task Test_CollectionShowObjectJsonReader_ReadObject_From_Stream_Incomplete_7()
        {
            var jsonReader = new CollectionShowObjectJsonReader();
        ...
        [Fact]
        public async Task Test_CollectionShowObjectJsonReader_ReadObject_From_Stream_Incomplete_8()
        {
            var jsonReader = new CollectionShowObjectJsonReader();
        ...
        {
            var jsonReader = new CollectionShowObjectJsonReader();
            Func<Task<ITraktCollectionShow>> traktCollectionShow = () => jsonReader.ReadObjectAsync(default(Stream));
