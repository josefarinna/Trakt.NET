namespace TraktNet.Objects.Get.Tests.Collections.Json.Writer
{
    ...
    {
        [Fact]
        public async Task Test_CollectionShowArrayJsonWriter_WriteArray_StringWriter_Exceptions()
        {
            ...
            Func<Task<string>> action = () => traktJsonWriter.WriteArrayAsync(default(StringWriter), traktCollectionShows);
            await action.Should().ThrowAsync<ArgumentNullException>();
        }

        [Fact]
        public async Task Test_CollectionShowArrayJsonWriter_WriteArray_StringWriter_Empty()
        {
            IEnumerable<ITraktCollectionShow> traktCollectionShows = new List<TraktCollectionShow>();
        ...
        [Fact]
        public async Task Test_CollectionShowArrayJsonWriter_WriteArray_StringWriter_SingleObject()
        {
        ...
        [Fact]
        public async Task Test_CollectionShowArrayJsonWriter_WriteArray_StringWriter_Complete()
        {
            IEnumerable<ITraktCollectionShow> traktCollectionShows = new List<ITraktCollectionShow>
            {
                new TraktCollectionShow
