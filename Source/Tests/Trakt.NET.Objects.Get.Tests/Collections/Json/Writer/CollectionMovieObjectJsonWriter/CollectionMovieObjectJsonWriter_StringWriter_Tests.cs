namespace TraktNet.Objects.Get.Tests.Collections.Json.Writer
{
    ...
    {
        [Fact]
        public async Task Test_CollectionMovieObjectJsonWriter_WriteObject_StringWriter_Exceptions()
        {
        ...
        [Fact]
        public async Task Test_CollectionMovieObjectJsonWriter_WriteObject_StringWriter_Only_Movie_Property()
        {
            ITraktCollectionMovie traktCollectionMovie = new TraktCollectionMovie
            {
        ...
        [Fact]
        public async Task Test_CollectionMovieObjectJsonWriter_WriteObject_StringWriter_Complete()
        {
            ITraktCollectionMovie traktCollectionMovie = new TraktCollectionMovie
            {
                CollectedAt = COLLECTED_AT,
