namespace TraktNet.Objects.Get.Tests.Collections.Implementations
{
    ...
    [Trait("Category", "Objects.Get.Collections.Implementations")]
    public class TraktCollectionShow_Tests
    {
        ...
        public void Test_TraktCollectionShow_Default_Constructor()
        {
            ...
            collectionShow.Tagline.Should().BeNullOrEmpty();
        ...
        public async Task Test_TraktCollectionShow_From_Minimal_Json()
        {
            ...
            collectionShow.Show.Tagline.Should().BeNullOrEmpty();
        ...
        public async Task Test_TraktCollectionShow_From_Full_Json()
        {
            ...
            collectionShow.Show.Tagline.Should().Be("Winter Is Coming");
            ...
            collectionShow.Tagline.Should().Be("Winter Is Coming");
