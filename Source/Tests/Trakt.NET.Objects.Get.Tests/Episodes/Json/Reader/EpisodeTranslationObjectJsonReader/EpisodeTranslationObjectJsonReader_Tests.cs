namespace TraktNet.Objects.Get.Tests.Episodes.Json.Reader
{
    ...
    public partial class EpisodeTranslationObjectJsonReader_Tests
    {
        ...
        public async Task Test_EpisodeTranslationObjectJsonReader_ReadObject_From_JsonReader_Complete()
        {
            ...
            traktEpisodeTranslation.Overview.Should().Be("Jon Arryn, the Hand of the King, is dead...");
            traktEpisodeTranslation.LanguageCode.Should().Be("en");
            traktEpisodeTranslation.CountryCode.Should().Be("us");
        }
        ...
        public async Task Test_EpisodeTranslationObjectJsonReader_ReadObject_From_JsonReader_Incomplete_4()
        {
            ...
            traktEpisodeTranslation.Overview.Should().Be("Jon Arryn, the Hand of the King, is dead...");
            traktEpisodeTranslation.LanguageCode.Should().Be("en");
            traktEpisodeTranslation.CountryCode.Should().BeNull();
        }
        ...
        [Fact]
        public async Task Test_EpisodeTranslationObjectJsonReader_ReadObject_From_JsonReader_Not_Valid_5()
        {
            var traktJsonReader = new EpisodeTranslationObjectJsonReader();
        ...
        {
            var traktJsonReader = new EpisodeTranslationObjectJsonReader();
            Func<Task<ITraktEpisodeTranslation>> traktEpisodeTranslation = () => traktJsonReader.ReadObjectAsync(default(JsonTextReader));
