    ...
    public partial class UserLikeItemObjectJsonReader_Tests
    {
        ...
        public async Task Test_UserLikeItemObjectJsonReader_Comment_ReadObject_From_JsonReader_Complete()
        {
            ...
            using (var jsonReader = new JsonTextReader(reader))
            {
                ...
                traktUserLikeItem.Comment.UserStats.Should().NotBeNull();
                traktUserLikeItem.Comment.UserStats.Rating.Should().Be(8);
                traktUserLikeItem.Comment.UserStats.PlayCount.Should().Be(1);
                traktUserLikeItem.Comment.UserStats.CompletedCount.Should().Be(1);
