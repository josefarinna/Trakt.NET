namespace TraktNet.Objects.Get.Tests.Calendars.Implementations
{
    ...
    public class TraktCalendarShow_Tests
    {
        ...
        public void Test_TraktCalendarShow_Default_Constructor()
        {
            ...
            calendarShow.Tagline.Should().BeNullOrEmpty();
        ...
        public async Task Test_TraktCalendarShow_From_Minimal_Json()
        {
            ...
            calendarShow.Show.Tagline.Should().BeNullOrEmpty();
        ...
        public async Task Test_TraktCalendarShow_From_Full_Json()
        {
            ...
            calendarShow.Show.Tagline.Should().Be("Winter Is Coming");
            ...
            calendarShow.Tagline.Should().Be("Winter Is Coming");
