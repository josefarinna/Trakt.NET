namespace TraktNet.Objects.Get.Tests.Calendars.Json.Reader
{
    ...
    public partial class CalendarShowObjectJsonReader_Tests
    {
        ...
        [Fact]
        public async Task Test_CalendarShowObjectJsonReader_ReadObject_From_JsonReader_Incomplete_1()
        {
            var traktJsonReader = new CalendarShowObjectJsonReader();
        ...
        [Fact]
        public async Task Test_CalendarShowObjectJsonReader_ReadObject_From_JsonReader_Incomplete_2()
        {
            var traktJsonReader = new CalendarShowObjectJsonReader();
        ...
        [Fact]
        public async Task Test_CalendarShowObjectJsonReader_ReadObject_From_JsonReader_Incomplete_3()
        {
            var traktJsonReader = new CalendarShowObjectJsonReader();
        ...
        [Fact]
        public async Task Test_CalendarShowObjectJsonReader_ReadObject_From_JsonReader_Incomplete_4()
        {
            var traktJsonReader = new CalendarShowObjectJsonReader();
        ...
        [Fact]
        public async Task Test_CalendarShowObjectJsonReader_ReadObject_From_JsonReader_Not_Valid_3()
        {
            var traktJsonReader = new CalendarShowObjectJsonReader();
