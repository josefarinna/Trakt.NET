namespace TraktNet.Objects.Get.Tests.Calendars.Json.Writer
{
    ...
    {
        [Fact]
        public async Task Test_CalendarShowArrayJsonWriter_WriteArray_Array_Exceptions()
        {
        ...
        [Fact]
        public async Task Test_CalendarShowArrayJsonWriter_WriteArray_Array_Empty()
        {
            IEnumerable<ITraktCalendarShow> traktCalendarShow = new List<TraktCalendarShow>();
            var traktJsonWriter = new ArrayJsonWriter<ITraktCalendarShow>();
            string json = await traktJsonWriter.WriteArrayAsync(traktCalendarShow);
            json.Should().Be("[]");
        }

        [Fact]
        public async Task Test_CalendarShowArrayJsonWriter_WriteArray_Array_SingleObject()
        {
        ...
        [Fact]
        public async Task Test_CalendarShowArrayJsonWriter_WriteArray_Array_Complete()
        {
            IEnumerable<ITraktCalendarShow> traktCalendarShow = new List<ITraktCalendarShow>
            {
                new TraktCalendarShow
