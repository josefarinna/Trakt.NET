namespace TraktNet.Objects.Get.Tests.Calendars.Json.Writer
{
    ...
    public partial class CalendarMovieArrayJsonWriter_Tests
    {
        ...
        [Fact]
        public async Task Test_CalendarMovieArrayJsonWriter_WriteArray_JsonWriter_Exceptions()
        {
            ...
            Func<Task> action = () => traktJsonWriter.WriteArrayAsync(default(JsonTextWriter), traktCalendarMovie);
            await action.Should().ThrowAsync<ArgumentNullException>();
        }

        [Fact]
        public async Task Test_CalendarMovieArrayJsonWriter_WriteArray_JsonWriter_Empty()
        {
            IEnumerable<ITraktCalendarMovie> traktCalendarMovie = new List<TraktCalendarMovie>();
            ...
            {
                var traktJsonWriter = new ArrayJsonWriter<ITraktCalendarMovie>();
                await traktJsonWriter.WriteArrayAsync(jsonWriter, traktCalendarMovie);
                stringWriter.ToString().Should().Be("[]");
            }
        }

        [Fact]
        public async Task Test_CalendarMovieArrayJsonWriter_WriteArray_JsonWriter_SingleObject()
        {
        ...
        [Fact]
        public async Task Test_CalendarMovieArrayJsonWriter_WriteArray_JsonWriter_Complete()
        {
            IEnumerable<ITraktCalendarMovie> traktCalendarMovie = new List<ITraktCalendarMovie>
            {
                new TraktCalendarMovie
