namespace TraktNet.Objects.Get.Tests.Calendars.Json.Writer
{
    ...
    public partial class CalendarShowObjectJsonWriter_Tests
    {
        ...
        [Fact]
        public async Task Test_CalendarShowObjectJsonWriter_WriteObject_JsonWriter_Exceptions()
        {
            var traktJsonWriter = new CalendarShowObjectJsonWriter();
            ITraktCalendarShow traktCalendarShow = new TraktCalendarShow();
            Func<Task> action = () => traktJsonWriter.WriteObjectAsync(default(JsonTextWriter), traktCalendarShow);
            await action.Should().ThrowAsync<ArgumentNullException>();
        }

        [Fact]
        public async Task Test_CalendarShowObjectJsonWriter_WriteObject_JsonWriter_Empty()
        {
            ITraktCalendarShow traktCalendarShow = new TraktCalendarShow();
            ...
            {
                var traktJsonWriter = new CalendarShowObjectJsonWriter();
                await traktJsonWriter.WriteObjectAsync(jsonWriter, traktCalendarShow);
                stringWriter.ToString().Should().Be("{}");
            }
        }

        [Fact]
        public async Task Test_CalendarShowObjectJsonWriter_WriteObject_JsonWriter_Only_FirstAiredInCalendar_Property()
        {
            ITraktCalendarShow traktCalendarShow = new TraktCalendarShow
            {
        ...
        [Fact]
        public async Task Test_CalendarShowObjectJsonWriter_WriteObject_JsonWriter_Only_Show_Property()
        {
            ITraktCalendarShow traktCalendarShow = new TraktCalendarShow
            {
                Show = new TraktShow
            ...
            using (var jsonWriter = new JsonTextWriter(stringWriter))
            {
                var traktJsonWriter = new CalendarShowObjectJsonWriter();
                await traktJsonWriter.WriteObjectAsync(jsonWriter, traktCalendarShow);
                stringWriter.ToString().Should().Be(@"{""show"":{""title"":""Game of Thrones"",""year"":2011,""ids"":{" +
        ...
        [Fact]
        public async Task Test_CalendarShowObjectJsonWriter_WriteObject_JsonWriter_Only_Episode_Property()
        {
            ITraktCalendarShow traktCalendarShow = new TraktCalendarShow
            {
            ...
            using (var jsonWriter = new JsonTextWriter(stringWriter))
            {
                var traktJsonWriter = new CalendarShowObjectJsonWriter();
                await traktJsonWriter.WriteObjectAsync(jsonWriter, traktCalendarShow);
                stringWriter.ToString().Should().Be(@"{""episode"":{""season"":1,""number"":1,""title"":""Winter Is Coming""," +
        ...
        [Fact]
        public async Task Test_CalendarShowObjectJsonWriter_WriteObject_JsonWriter_Complete()
        {
            ITraktCalendarShow traktCalendarShow = new TraktCalendarShow
            {
                FirstAiredInCalendar = FIRST_AIRED,
