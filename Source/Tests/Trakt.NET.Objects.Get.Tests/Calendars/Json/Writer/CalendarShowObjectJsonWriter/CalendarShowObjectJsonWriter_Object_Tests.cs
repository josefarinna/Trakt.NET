namespace TraktNet.Objects.Get.Tests.Calendars.Json.Writer
{
    ...
    public partial class CalendarShowObjectJsonWriter_Tests
    {
        ...
        [Fact]
        public async Task Test_CalendarShowObjectJsonWriter_WriteObject_Object_Empty()
        {
            ITraktCalendarShow traktCalendarShow = new TraktCalendarShow();
            var traktJsonWriter = new CalendarShowObjectJsonWriter();
            string json = await traktJsonWriter.WriteObjectAsync(traktCalendarShow);
            json.Should().Be("{}");
        }

        [Fact]
        public async Task Test_CalendarShowObjectJsonWriter_WriteObject_Object_Only_FirstAiredInCalendar_Property()
        {
            ITraktCalendarShow traktCalendarShow = new TraktCalendarShow
            {
        ...
        [Fact]
        public async Task Test_CalendarShowObjectJsonWriter_WriteObject_Object_Only_Show_Property()
        {
            ITraktCalendarShow traktCalendarShow = new TraktCalendarShow
            {
                Show = new TraktShow
        ...
        [Fact]
        public async Task Test_CalendarShowObjectJsonWriter_WriteObject_Object_Only_Episode_Property()
        {
            ITraktCalendarShow traktCalendarShow = new TraktCalendarShow
            {
        ...
        [Fact]
        public async Task Test_CalendarShowObjectJsonWriter_WriteObject_Object_Complete()
        {
            ITraktCalendarShow traktCalendarShow = new TraktCalendarShow
            {
                FirstAiredInCalendar = FIRST_AIRED,
