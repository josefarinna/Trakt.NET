namespace TraktNet.Objects.Get.Tests.Calendars.Json.Writer
{
    ...
    {
        [Fact]
        public async Task Test_CalendarMovieObjectJsonWriter_WriteObject_StringWriter_Exceptions()
        {
        ...
        [Fact]
        public async Task Test_CalendarMovieObjectJsonWriter_WriteObject_StringWriter_Only_Movie_Property()
        {
            ITraktCalendarMovie traktCalendarMovie = new TraktCalendarMovie
            {
