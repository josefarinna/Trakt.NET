namespace TraktNet.Requests.Tests.Lists
{
    ...
    public class ListCommentsRequest_Tests
    {
        ...
        {
            var request = new ListCommentsRequest();
            request.UriTemplate.Should().Be("lists/{id}/comments{/sort_order}{?extended,page,limit}");
        }
        ...
        public class ListCommentsRequest_TestData : IEnumerable<object[]>
        {
            ...
            private static readonly ListCommentsRequest _request9 = new ListCommentsRequest
            {
                Id = _id,
                ExtendedInfo = _extendedInfo,
                Page = _page
            ...
            private static readonly ListCommentsRequest _request10 = new ListCommentsRequest
            {
                Id = _id,
                ExtendedInfo = _extendedInfo,
                Limit = _limit
            ...
            private static readonly ListCommentsRequest _request11 = new ListCommentsRequest
            {
                Id = _id,
                SortOrder = _sortOrder,
                Page = _page,
            ...
            private static readonly ListCommentsRequest _request12 = new ListCommentsRequest
            {
                Id = _id,
                ExtendedInfo = _extendedInfo,
                Page = _page,
            ...
            private static readonly ListCommentsRequest _request13 = new ListCommentsRequest
            {
                Id = _id,
                Page = _page,
                Limit = _limit
            ...
            private static readonly ListCommentsRequest _request14 = new ListCommentsRequest
            {
                Id = _id,
                SortOrder = _sortOrder,
                ExtendedInfo = _extendedInfo,
