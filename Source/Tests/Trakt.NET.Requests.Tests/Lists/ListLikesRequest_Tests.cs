namespace TraktNet.Requests.Tests.Lists
{
    ...
    public class ListLikesRequest_Tests
    {
        ...
        {
            var request = new ListLikesRequest();
            request.UriTemplate.Should().Be("lists/{id}/likes{?extended,page,limit}");
        }
        ...
        public class ListLikesRequest_TestData : IEnumerable<object[]>
        {
            ...
            private static readonly ListLikesRequest _request5 = new ListLikesRequest
            {
                Id = _id,
                ExtendedInfo = _extendedInfo,
                Page = _page
            ...
            private static readonly ListLikesRequest _request6 = new ListLikesRequest
            {
                Id = _id,
                ExtendedInfo = _extendedInfo,
                Limit = _limit
            ...
            private static readonly ListLikesRequest _request7 = new ListLikesRequest
            {
                Id = _id,
                Page = _page,
                Limit = _limit
            ...
            private static readonly ListLikesRequest _request8 = new ListLikesRequest
            {
                Id = _id,
                ExtendedInfo = _extendedInfo,
                Page = _page,
