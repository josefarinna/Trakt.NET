namespace TraktNet.Requests.Tests.Recommendations.OAuth
{
    ...
    public class UserMovieRecommendationsRequest_Tests
    {
        ...
        {
            var request = new UserMovieRecommendationsRequest();
            request.UriTemplate.Should().Be("recommendations/movies{?extended,page,limit,ignore_collected,ignore_watchlisted}");
        }
        ...
        public class UserMovieRecommendationsRequest_TestData : IEnumerable<object[]>
        {
            ...
            private static readonly UserMovieRecommendationsRequest _request14 = new UserMovieRecommendationsRequest
            {
                ExtendedInfo = _extendedInfo,
                Page = _page,
                Limit = _limit,
