namespace TraktNet.Objects.Basic.Tests.Json.Writer
{
    ...
    {
        [Fact]
        public async Task Test_RatingObjectJsonWriter_WriteObject_Object_Exceptions()
        {
        ...
        [Fact]
        public async Task Test_RatingObjectJsonWriter_WriteObject_Object_Only_Distribution_Property()
        {
            ITraktRating traktRating = new TraktRating
            {
        ...
        [Fact]
        public async Task Test_RatingObjectJsonWriter_WriteObject_Object_Only_Distribution_Property_Incomplete()
        {
            ITraktRating traktRating = new TraktRating
            {
                Distribution = new Dictionary<string, int>
        ...
        [Fact]
        public async Task Test_RatingObjectJsonWriter_WriteObject_Object_Complete()
        {
            ITraktRating traktRating = new TraktRating
            {
                Rating = 7.4561f,
