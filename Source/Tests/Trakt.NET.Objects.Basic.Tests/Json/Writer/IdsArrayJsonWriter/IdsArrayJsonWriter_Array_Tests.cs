namespace TraktNet.Objects.Basic.Tests.Json.Writer
{
    ...
    {
        [Fact]
        public async Task Test_IdsArrayJsonWriter_WriteArray_Array_Exceptions()
        {
        ...
        [Fact]
        public async Task Test_IdsArrayJsonWriter_WriteArray_Array_Empty()
        {
            IEnumerable<ITraktIds> traktIds = new List<TraktIds>();
            var traktJsonWriter = new ArrayJsonWriter<ITraktIds>();
            string json = await traktJsonWriter.WriteArrayAsync(traktIds);
            json.Should().Be("[]");
        }

        [Fact]
        public async Task Test_IdsArrayJsonWriter_WriteArray_Array_SingleObject()
        {
        ...
        [Fact]
        public async Task Test_IdsArrayJsonWriter_WriteArray_Array_Complete()
        {
            IEnumerable<ITraktIds> traktIds = new List<ITraktIds>
            {
                new TraktIds
