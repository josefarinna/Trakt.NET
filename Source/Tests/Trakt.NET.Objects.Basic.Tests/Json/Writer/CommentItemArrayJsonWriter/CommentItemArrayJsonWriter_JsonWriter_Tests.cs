namespace TraktNet.Objects.Basic.Tests.Json.Writer
{
    ...
    public partial class CommentItemArrayJsonWriter_Tests
    {
        ...
        [Fact]
        public async Task Test_CommentItemArrayJsonWriter_WriteArray_JsonWriter_Exceptions()
        {
            ...
            Func<Task> action = () => traktJsonWriter.WriteArrayAsync(default(JsonTextWriter), traktCommentItems);
            await action.Should().ThrowAsync<ArgumentNullException>();
        }

        [Fact]
        public async Task Test_CommentItemArrayJsonWriter_WriteArray_JsonWriter_Empty()
        {
            IEnumerable<ITraktCommentItem> traktCommentItems = new List<TraktCommentItem>();
            ...
            {
                var traktJsonWriter = new ArrayJsonWriter<ITraktCommentItem>();
                await traktJsonWriter.WriteArrayAsync(jsonWriter, traktCommentItems);
                stringWriter.ToString().Should().Be("[]");
            }
        }

        [Fact]
        public async Task Test_CommentItemArrayJsonWriter_WriteArray_JsonWriter_SingleObject()
        {
        ...
        [Fact]
        public async Task Test_CommentItemArrayJsonWriter_WriteArray_JsonWriter_Complete()
        {
            IEnumerable<ITraktCommentItem> traktCommentItems = new List<ITraktCommentItem>
            {
                new TraktCommentItem
