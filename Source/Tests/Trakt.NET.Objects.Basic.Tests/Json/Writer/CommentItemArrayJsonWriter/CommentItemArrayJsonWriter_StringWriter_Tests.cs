namespace TraktNet.Objects.Basic.Tests.Json.Writer
{
    ...
    {
        [Fact]
        public async Task Test_CommentItemArrayJsonWriter_WriteArray_StringWriter_Exceptions()
        {
            ...
            Func<Task<string>> action = () => traktJsonWriter.WriteArrayAsync(default(StringWriter), traktCommentItems);
            await action.Should().ThrowAsync<ArgumentNullException>();
        }

        [Fact]
        public async Task Test_CommentItemArrayJsonWriter_WriteArray_StringWriter_Empty()
        {
            IEnumerable<ITraktCommentItem> traktCommentItems = new List<TraktCommentItem>();
        ...
        [Fact]
        public async Task Test_CommentItemArrayJsonWriter_WriteArray_StringWriter_Complete()
        {
            IEnumerable<ITraktCommentItem> traktCommentItems = new List<ITraktCommentItem>
            {
                new TraktCommentItem
