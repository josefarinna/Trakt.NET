namespace TraktNet.Objects.Basic.Tests.Json.Writer
{
    ...
    public partial class CommentItemObjectJsonWriter_Tests
    {
        ...
        [Fact]
        public async Task Test_CommentItemObjectJsonWriter_WriteObject_StringWriter_Only_Movie_Property()
        {
            ITraktCommentItem traktCommentItem = new TraktCommentItem
            {
        ...
        [Fact]
        public async Task Test_CommentItemObjectJsonWriter_WriteObject_StringWriter_Only_Show_Property()
        {
            ITraktCommentItem traktCommentItem = new TraktCommentItem
            {
                Show = new TraktShow
        ...
        [Fact]
        public async Task Test_CommentItemObjectJsonWriter_WriteObject_StringWriter_Only_Season_Property()
        {
            ITraktCommentItem traktCommentItem = new TraktCommentItem
            {
        ...
        [Fact]
        public async Task Test_CommentItemObjectJsonWriter_WriteObject_StringWriter_Only_Episode_Property()
        {
            ITraktCommentItem traktCommentItem = new TraktCommentItem
            {
        ...
        [Fact]
        public async Task Test_CommentItemObjectJsonWriter_WriteObject_StringWriter_Complete()
        {
            ITraktCommentItem traktCommentItem = new TraktCommentItem
            {
                Type = TraktObjectType.Movie,
