namespace TraktNet.Objects.Basic.Tests.Json.Writer
{
    ...
    public partial class SearchResultArrayJsonWriter_Tests
    {
        ...
        [Fact]
        public async Task Test_SearchResultArrayJsonWriter_WriteArray_JsonWriter_Empty()
        {
            IEnumerable<ITraktSearchResult> traktSearchResults = new List<TraktSearchResult>();
            ...
            {
                var traktJsonWriter = new ArrayJsonWriter<ITraktSearchResult>();
                await traktJsonWriter.WriteArrayAsync(jsonWriter, traktSearchResults);
                stringWriter.ToString().Should().Be("[]");
            }
        }

        [Fact]
        public async Task Test_SearchResultArrayJsonWriter_WriteArray_JsonWriter_SingleObject()
        {
        ...
        [Fact]
        public async Task Test_SearchResultArrayJsonWriter_WriteArray_JsonWriter_Complete()
        {
            IEnumerable<ITraktSearchResult> traktSearchResults = new List<ITraktSearchResult>
            {
                new TraktSearchResult
