namespace TraktNet.Objects.Basic.Tests.Json.Reader
{
    ...
    {
        [Fact]
        public async Task Test_CastAndCrewObjectJsonReader_ReadObject_From_Json_String_Complete()
        {
            var jsonReader = new CastAndCrewObjectJsonReader();

            var traktCastAndCrew = await jsonReader.ReadObjectAsync(JSON_COMPLETE);
            ...
            castMemberItems[1].Characters.Should().NotBeNull().And.HaveCount(1).And.Contain("Jules Winfield");
            ...
            crewCrew[0].Jobs.Should().NotBeNull().And.HaveCount(1).And.Contain("Crew Member");
            ...
            crewCrew[1].Jobs.Should().NotBeNull().And.HaveCount(1).And.Contain("Crew Member");
        ...
        [Fact]
        public async Task Test_CastAndCrewObjectJsonReader_ReadObject_From_Json_String_Incomplete_1()
        {
            var jsonReader = new CastAndCrewObjectJsonReader();

            var traktCastAndCrew = await jsonReader.ReadObjectAsync(JSON_INCOMPLETE_1);
        ...
        [Fact]
        public async Task Test_CastAndCrewObjectJsonReader_ReadObject_From_Json_String_Incomplete_2()
        {
            var jsonReader = new CastAndCrewObjectJsonReader();

            var traktCastAndCrew = await jsonReader.ReadObjectAsync(JSON_INCOMPLETE_2);
        ...
        [Fact]
        public async Task Test_CastAndCrewObjectJsonReader_ReadObject_From_Json_String_Not_Valid_1()
        {
            var jsonReader = new CastAndCrewObjectJsonReader();

            var traktCastAndCrew = await jsonReader.ReadObjectAsync(JSON_NOT_VALID_1);
        ...
        [Fact]
        public async Task Test_CastAndCrewObjectJsonReader_ReadObject_From_Json_String_Not_Valid_2()
        {
            var jsonReader = new CastAndCrewObjectJsonReader();

            var traktCastAndCrew = await jsonReader.ReadObjectAsync(JSON_NOT_VALID_2);
        ...
        [Fact]
        public async Task Test_CastAndCrewObjectJsonReader_ReadObject_From_Json_String_Not_Valid_3()
        {
            var jsonReader = new CastAndCrewObjectJsonReader();

            var traktCastAndCrew = await jsonReader.ReadObjectAsync(JSON_NOT_VALID_3);
        ...
        [Fact]
        public async Task Test_CastAndCrewObjectJsonReader_ReadObject_From_Json_String_Null()
        {
            var jsonReader = new CastAndCrewObjectJsonReader();
            Func<Task<ITraktCastAndCrew>> traktCastAndCrew = () => jsonReader.ReadObjectAsync(default(string));
            await traktCastAndCrew.Should().ThrowAsync<ArgumentNullException>();
        }

        [Fact]
        public async Task Test_CastAndCrewObjectJsonReader_ReadObject_From_Json_String_Empty()
        {
            var jsonReader = new CastAndCrewObjectJsonReader();

            var traktCastAndCrew = await jsonReader.ReadObjectAsync(string.Empty);
