namespace TraktNet.Objects.Basic.Tests.Json.Reader
{
    ...
    {
        [Fact]
        public async Task Test_CastAndCrewObjectJsonReader_ReadObject_From_JsonReader_Complete()
        {
            var traktJsonReader = new CastAndCrewObjectJsonReader();

            using (var reader = new StringReader(JSON_COMPLETE))
            using (var jsonReader = new JsonTextReader(reader))
            {
                var traktCastAndCrew = await traktJsonReader.ReadObjectAsync(jsonReader);
        ...
        [Fact]
        public async Task Test_CastAndCrewObjectJsonReader_ReadObject_From_JsonReader_Incomplete_1()
        {
            var traktJsonReader = new CastAndCrewObjectJsonReader();
        ...
        [Fact]
        public async Task Test_CastAndCrewObjectJsonReader_ReadObject_From_JsonReader_Incomplete_2()
        {
            var traktJsonReader = new CastAndCrewObjectJsonReader();
        ...
        [Fact]
        public async Task Test_CastAndCrewObjectJsonReader_ReadObject_From_JsonReader_Not_Valid_1()
        {
            var traktJsonReader = new CastAndCrewObjectJsonReader();
        ...
        [Fact]
        public async Task Test_CastAndCrewObjectJsonReader_ReadObject_From_JsonReader_Not_Valid_2()
        {
            var traktJsonReader = new CastAndCrewObjectJsonReader();
        ...
        [Fact]
        public async Task Test_CastAndCrewObjectJsonReader_ReadObject_From_JsonReader_Not_Valid_3()
        {
            var traktJsonReader = new CastAndCrewObjectJsonReader();
        ...
        [Fact]
        public async Task Test_CastAndCrewObjectJsonReader_ReadObject_From_JsonReader_Null()
        {
            var traktJsonReader = new CastAndCrewObjectJsonReader();
            Func<Task<ITraktCastAndCrew>> traktCastAndCrew = () => traktJsonReader.ReadObjectAsync(default(JsonTextReader));
            await traktCastAndCrew.Should().ThrowAsync<ArgumentNullException>();
        }

        [Fact]
        public async Task Test_CastAndCrewObjectJsonReader_ReadObject_From_JsonReader_Empty()
        {
            var traktJsonReader = new CastAndCrewObjectJsonReader();
