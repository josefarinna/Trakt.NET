namespace TraktNet.Objects.Basic.Tests.Json.Reader
{
    ...
    {
        [Fact]
        public async Task Test_SearchResultArrayJsonReader_Episode_ReadArray_From_JsonReader_Empty_Array()
        {
        ...
        [Fact]
        public async Task Test_SearchResultArrayJsonReader_Episode_ReadArray_From_JsonReader_Complete()
        {
            var traktJsonReader = new ArrayJsonReader<ITraktSearchResult>();
        ...
        [Fact]
        public async Task Test_SearchResultArrayJsonReader_Episode_ReadArray_From_JsonReader_Incomplete_1()
        {
            var traktJsonReader = new ArrayJsonReader<ITraktSearchResult>();
        ...
        [Fact]
        public async Task Test_SearchResultArrayJsonReader_Episode_ReadArray_From_JsonReader_Incomplete_2()
        {
            var traktJsonReader = new ArrayJsonReader<ITraktSearchResult>();
        ...
        [Fact]
        public async Task Test_SearchResultArrayJsonReader_Episode_ReadArray_From_JsonReader_Not_Valid_1()
        {
            var traktJsonReader = new ArrayJsonReader<ITraktSearchResult>();
        ...
        [Fact]
        public async Task Test_SearchResultArrayJsonReader_Episode_ReadArray_From_JsonReader_Not_Valid_2()
        {
            var traktJsonReader = new ArrayJsonReader<ITraktSearchResult>();
        ...
        [Fact]
        public async Task Test_SearchResultArrayJsonReader_Episode_ReadArray_From_JsonReader_Not_Valid_3()
        {
            var traktJsonReader = new ArrayJsonReader<ITraktSearchResult>();
