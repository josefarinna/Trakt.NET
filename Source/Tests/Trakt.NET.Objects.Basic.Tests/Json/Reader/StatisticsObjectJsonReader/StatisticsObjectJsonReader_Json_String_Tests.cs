namespace TraktNet.Objects.Basic.Tests.Json.Reader
{
    ...
    {
        [Fact]
        public async Task Test_StatisticsObjectJsonReader_ReadObject_From_Json_String_Complete()
        {
        ...
        [Fact]
        public async Task Test_StatisticsObjectJsonReader_ReadObject_From_Json_String_Incomplete_1()
        {
            var jsonReader = new StatisticsObjectJsonReader();
        ...
        [Fact]
        public async Task Test_StatisticsObjectJsonReader_ReadObject_From_Json_String_Incomplete_2()
        {
            var jsonReader = new StatisticsObjectJsonReader();
        ...
        [Fact]
        public async Task Test_StatisticsObjectJsonReader_ReadObject_From_Json_String_Incomplete_3()
        {
            var jsonReader = new StatisticsObjectJsonReader();
        ...
        [Fact]
        public async Task Test_StatisticsObjectJsonReader_ReadObject_From_Json_String_Incomplete_4()
        {
            var jsonReader = new StatisticsObjectJsonReader();
        ...
        [Fact]
        public async Task Test_StatisticsObjectJsonReader_ReadObject_From_Json_String_Incomplete_5()
        {
            var jsonReader = new StatisticsObjectJsonReader();
        ...
        [Fact]
        public async Task Test_StatisticsObjectJsonReader_ReadObject_From_Json_String_Incomplete_6()
        {
            var jsonReader = new StatisticsObjectJsonReader();
        ...
        [Fact]
        public async Task Test_StatisticsObjectJsonReader_ReadObject_From_Json_String_Incomplete_7()
        {
            var jsonReader = new StatisticsObjectJsonReader();
        ...
        [Fact]
        public async Task Test_StatisticsObjectJsonReader_ReadObject_From_Json_String_Incomplete_8()
        {
            var jsonReader = new StatisticsObjectJsonReader();
        ...
        [Fact]
        public async Task Test_StatisticsObjectJsonReader_ReadObject_From_Json_String_Incomplete_9()
        {
            var jsonReader = new StatisticsObjectJsonReader();
        ...
        [Fact]
        public async Task Test_StatisticsObjectJsonReader_ReadObject_From_Json_String_Incomplete_10()
        {
            var jsonReader = new StatisticsObjectJsonReader();
        ...
        [Fact]
        public async Task Test_StatisticsObjectJsonReader_ReadObject_From_Json_String_Incomplete_11()
        {
            var jsonReader = new StatisticsObjectJsonReader();
        ...
        [Fact]
        public async Task Test_StatisticsObjectJsonReader_ReadObject_From_Json_String_Incomplete_12()
        {
            var jsonReader = new StatisticsObjectJsonReader();
        ...
        [Fact]
        public async Task Test_StatisticsObjectJsonReader_ReadObject_From_Json_String_Incomplete_13()
        {
            var jsonReader = new StatisticsObjectJsonReader();
        ...
        [Fact]
        public async Task Test_StatisticsObjectJsonReader_ReadObject_From_Json_String_Incomplete_14()
        {
            var jsonReader = new StatisticsObjectJsonReader();
        ...
        [Fact]
        public async Task Test_StatisticsObjectJsonReader_ReadObject_From_Json_String_Not_Valid_1()
        {
            var jsonReader = new StatisticsObjectJsonReader();
        ...
        [Fact]
        public async Task Test_StatisticsObjectJsonReader_ReadObject_From_Json_String_Not_Valid_2()
        {
            var jsonReader = new StatisticsObjectJsonReader();
        ...
        [Fact]
        public async Task Test_StatisticsObjectJsonReader_ReadObject_From_Json_String_Not_Valid_3()
        {
            var jsonReader = new StatisticsObjectJsonReader();
        ...
        [Fact]
        public async Task Test_StatisticsObjectJsonReader_ReadObject_From_Json_String_Not_Valid_4()
        {
            var jsonReader = new StatisticsObjectJsonReader();
        ...
        [Fact]
        public async Task Test_StatisticsObjectJsonReader_ReadObject_From_Json_String_Not_Valid_5()
        {
            var jsonReader = new StatisticsObjectJsonReader();
        ...
        [Fact]
        public async Task Test_StatisticsObjectJsonReader_ReadObject_From_Json_String_Not_Valid_6()
        {
            var jsonReader = new StatisticsObjectJsonReader();
        ...
        [Fact]
        public async Task Test_StatisticsObjectJsonReader_ReadObject_From_Json_String_Not_Valid_7()
        {
            var jsonReader = new StatisticsObjectJsonReader();
        ...
        [Fact]
        public async Task Test_StatisticsObjectJsonReader_ReadObject_From_Json_String_Not_Valid_8()
        {
            var jsonReader = new StatisticsObjectJsonReader();
        ...
        [Fact]
        public async Task Test_StatisticsObjectJsonReader_ReadObject_From_Json_String_Null()
        {
            var jsonReader = new StatisticsObjectJsonReader();
            Func<Task<ITraktStatistics>> traktStatistics = () => jsonReader.ReadObjectAsync(default(string));
            await traktStatistics.Should().ThrowAsync<ArgumentNullException>();
        }

        [Fact]
        public async Task Test_StatisticsObjectJsonReader_ReadObject_From_Json_String_Empty()
        {
            var jsonReader = new StatisticsObjectJsonReader();
