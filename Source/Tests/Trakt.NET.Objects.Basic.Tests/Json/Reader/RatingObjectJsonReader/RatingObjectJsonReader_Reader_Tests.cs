namespace TraktNet.Objects.Basic.Tests.Json.Reader
{
    ...
    {
        [Fact]
        public async Task Test_RatingObjectJsonReader_ReadObject_From_JsonReader_Complete()
        {
        ...
        [Fact]
        public async Task Test_RatingObjectJsonReader_ReadObject_From_JsonReader_Incomplete_1()
        {
            var traktJsonReader = new RatingObjectJsonReader();
        ...
        [Fact]
        public async Task Test_RatingObjectJsonReader_ReadObject_From_JsonReader_Incomplete_4()
        {
            var traktJsonReader = new RatingObjectJsonReader();
        ...
        [Fact]
        public async Task Test_RatingObjectJsonReader_ReadObject_From_JsonReader_Not_Valid_1()
        {
            var traktJsonReader = new RatingObjectJsonReader();
        ...
        [Fact]
        public async Task Test_RatingObjectJsonReader_ReadObject_From_JsonReader_Not_Valid_2()
        {
            var traktJsonReader = new RatingObjectJsonReader();
        ...
        [Fact]
        public async Task Test_RatingObjectJsonReader_ReadObject_From_JsonReader_Not_Valid_3()
        {
            var traktJsonReader = new RatingObjectJsonReader();
        ...
        [Fact]
        public async Task Test_RatingObjectJsonReader_ReadObject_From_JsonReader_Not_Valid_5()
        {
            var traktJsonReader = new RatingObjectJsonReader();
