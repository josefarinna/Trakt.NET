namespace TraktNet.Modules
{
    ...
    public partial class TraktUsersModule : ATraktModule
    {
        ...
        /// <para>
        /// See <a href="https://docs.trakt.tv/referencereference/users/add-list-items/add-items-to-personal-list">"Trakt API Doc - Users: List Items"</a> for more information.
        /// </para>
        /// <para>
        ...
        public Task<TraktResponse<ITraktUserPersonalListItemsPostResponse>> AddPersonalListItemsAsync(string usernameOrSlug, ITraktList list,
                                                                                                      ITraktUserPersonalListItemsPost listItemsPost,
                                                                                                      CancellationToken cancellationToken = default)
        {
            if (list == null)
