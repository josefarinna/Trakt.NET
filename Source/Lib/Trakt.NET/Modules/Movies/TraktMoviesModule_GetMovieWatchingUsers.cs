namespace TraktNet.Modules
{
    ...
    public partial class TraktMoviesModule : ATraktModule
    {
        ...
        /// <para>
        /// See <a href="https://docs.trakt.tv/reference/getmovieswatching">"Trakt API Doc - Movies: Watching"</a> for more information.
        /// </para>
        /// </summary>
        ...
        public Task<TraktListResponse<ITraktUser>> GetMovieWatchingUsersAsync(uint traktMovieId, TraktExtendedInfo extendedInfo = null,
                                                                              CancellationToken cancellationToken = default)
        {
            if (traktMovieId == 0)
                throw new ArgumentException("movie id must not be 0", nameof(traktMovieId));

            return GetMovieWatchingUsersAsync(traktMovieId.ToString(), extendedInfo, cancellationToken);
        }
        ...
        public Task<TraktListResponse<ITraktUser>> GetMovieWatchingUsersAsync(ITraktMovieIds movieIds, TraktExtendedInfo extendedInfo = null,
                                                                              CancellationToken cancellationToken = default)
        {
            if (movieIds == null)
