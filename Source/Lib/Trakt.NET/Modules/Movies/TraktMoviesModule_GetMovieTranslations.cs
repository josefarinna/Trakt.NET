namespace TraktNet.Modules
{
    ...
    public partial class TraktMoviesModule : ATraktModule
    {
        ...
        /// <para>
        /// See <a href="https://docs.trakt.tv/reference/getmoviessummary/translations/get-all-movie-translations">"Trakt API Doc - Movies: Translations"</a> for more information.
        /// </para>
        /// </summary>
        ...
        public Task<TraktListResponse<ITraktMovieTranslation>> GetMovieTranslationsAsync(ITraktMovie movie, string languageCode = null,
                                                                                         CancellationToken cancellationToken = default)
        {
            if (movie == null)
                throw new ArgumentNullException(nameof(movie));

            return GetMovieTranslationsAsync(movie.Ids, languageCode, cancellationToken);
        }
    }
}
