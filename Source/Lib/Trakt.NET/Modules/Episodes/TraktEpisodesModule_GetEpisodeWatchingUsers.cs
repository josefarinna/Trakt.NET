namespace TraktNet.Modules
{
    ...
    public partial class TraktEpisodesModule : ATraktModule
    {
        ...
        /// <para>
        /// See <a href="https://docs.trakt.tv/reference/getshowsepisodeinfo/watching/get-users-watching-right-now">"Trakt API Doc - Episodes: Watching"</a> for more information.
        /// </para>
        /// </summary>
        ...
        public Task<TraktListResponse<ITraktUser>> GetEpisodeWatchingUsersAsync(ITraktShow show, uint seasonNumber, uint episodeNumber,
                                                                                TraktExtendedInfo extendedInfo = null,
                                                                                CancellationToken cancellationToken = default)
        {
            if (show == null)
