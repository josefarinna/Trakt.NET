namespace TraktNet.Modules
{
    ...
    public partial class TraktListsModule : ATraktModule
    {
        ...
        /// </para>
        /// </summary>
        /// <param name="listIdOrSlug">The id or slug of the list, which will be liked. See also <seealso cref="ITraktListIds" />.</param>
        ...
        /// </para>
        /// </summary>
        /// <param name="traktListId">The Trakt ID of the list, which will be liked. See also <seealso cref="ITraktListIds" />.</param>
        /// <param name="cancellationToken">
        /// Propagates notification that the request should be canceled.<para/>
        /// If provided, the exception <see cref="OperationCanceledException" /> should be catched.
        /// </param>
        ...
        /// </para>
        /// </summary>
        /// <param name="listIds">The ids of the list, which will be liked. See also <seealso cref="ITraktListIds" />.</param>
        /// <param name="cancellationToken">
        /// Propagates notification that the request should be canceled.<para/>
        /// If provided, the exception <see cref="OperationCanceledException" /> should be catched.
        /// </param>
        ...
        /// </para>
        /// </summary>
        /// <param name="list">The list, which will be liked. See also <seealso cref="ITraktList" />.</param>
        /// <param name="cancellationToken">
        /// Propagates notification that the request should be canceled.<para/>
        /// If provided, the exception <see cref="OperationCanceledException" /> should be catched.
        /// </param>
        ...
        public Task<TraktNoContentResponse> LikeListAsync(ITraktList list, CancellationToken cancellationToken = default)
        {
            if (list == null)
