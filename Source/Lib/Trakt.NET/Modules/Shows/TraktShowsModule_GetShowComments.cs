namespace TraktNet.Modules
{
    ...
    public partial class TraktShowsModule : ATraktModule
    {
        ...
        /// <para>
        /// See <a href="https://docs.trakt.tv/referencereference/shows/translations/get-all-show-comments">"Trakt API Doc - Shows: Comments"</a> for more information.
        /// </para>
        /// </summary>
        ...
        public Task<TraktPagedResponse<ITraktComment>> GetShowCommentsAsync(ITraktShow show,
                                                                            TraktShowsCommentSortOrder commentSortOrder = null,
                                                                            TraktExtendedInfo extendedInfo = null,
                                                                            TraktPagedParameters pagedParameters = null,
                                                                            CancellationToken cancellationToken = default)
        {
            ...
            return GetShowCommentsAsync(show.Ids, commentSortOrder, extendedInfo, pagedParameters, cancellationToken);
        }
    }
}
