namespace TraktNet.Modules
{
    ...
    public partial class TraktShowsModule : ATraktModule
    {
        ...
        /// <para>
        /// See <a href="https://docs.trakt.tv/referencereference/shows/studios/get-show-studios">"Trakt API Doc - Shows: Studios"</a> for more information.
        /// </para>
        /// </summary>
        ...
        public Task<TraktListResponse<ITraktStudio>> GetShowStudiosAsync(uint traktShowID, CancellationToken cancellationToken = default)
        {
            if (traktShowID == 0)
                throw new ArgumentException("show id must not be 0", nameof(traktShowID));

            return GetShowStudiosAsync(traktShowID.ToString(), cancellationToken);
        }
        ...
        public Task<TraktListResponse<ITraktStudio>> GetShowStudiosAsync(ITraktShowIds showIds, CancellationToken cancellationToken = default)
        {
            if (showIds == null)
            ...
            return GetShowStudiosAsync(showIds.GetBestId(), cancellationToken);
        }
        ...
        public Task<TraktListResponse<ITraktStudio>> GetShowStudiosAsync(ITraktShow show, CancellationToken cancellationToken = default)
        {
            if (show == null)
                throw new ArgumentNullException(nameof(show));

            return GetShowStudiosAsync(show.Ids, cancellationToken);
        }
    }
}
