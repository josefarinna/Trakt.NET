namespace TraktNet.Modules
{
    ...
    public partial class TraktShowsModule : ATraktModule
    {
        ...
        /// <para>
        /// See <a href="https://docs.trakt.tv/referencereference/shows/watching/get-users-watching-right-now">"Trakt API Doc - Shows: Watching"</a> for more information.
        /// </para>
        /// </summary>
        ...
        public Task<TraktListResponse<ITraktUser>> GetShowWatchingUsersAsync(uint traktShowID, TraktExtendedInfo extendedInfo = null,
                                                                             CancellationToken cancellationToken = default)
        {
            if (traktShowID == 0)
                throw new ArgumentException("show id must not be 0", nameof(traktShowID));

            return GetShowWatchingUsersAsync(traktShowID.ToString(), extendedInfo, cancellationToken);
        }
        ...
        public Task<TraktListResponse<ITraktUser>> GetShowWatchingUsersAsync(ITraktShowIds showIds, TraktExtendedInfo extendedInfo = null,
                                                                             CancellationToken cancellationToken = default)
        {
            if (showIds == null)
            ...
            return GetShowWatchingUsersAsync(showIds.GetBestId(), extendedInfo, cancellationToken);
        }
        ...
        public Task<TraktListResponse<ITraktUser>> GetShowWatchingUsersAsync(ITraktShow show, TraktExtendedInfo extendedInfo = null,
                                                                             CancellationToken cancellationToken = default)
        {
            if (show == null)
                throw new ArgumentNullException(nameof(show));

            return GetShowWatchingUsersAsync(show.Ids, extendedInfo, cancellationToken);
        }
    }
}
