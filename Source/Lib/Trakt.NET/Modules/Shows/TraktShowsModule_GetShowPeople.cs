namespace TraktNet.Modules
{
    ...
    public partial class TraktShowsModule : ATraktModule
    {
        ...
        /// <para>
        /// See <a href="https://docs.trakt.tv/referencereference/shows/people/get-all-people-for-a-show">"Trakt API Doc - Shows: People"</a> for more information.
        /// </para>
        /// </summary>
        ...
        public Task<TraktResponse<ITraktShowCastAndCrew>> GetShowPeopleAsync(ITraktShow show, TraktExtendedInfo extendedInfo = null,
                                                                             CancellationToken cancellationToken = default)
        {
            if (show == null)
                throw new ArgumentNullException(nameof(show));

            return GetShowPeopleAsync(show.Ids, extendedInfo, cancellationToken);
        }
    }
}
