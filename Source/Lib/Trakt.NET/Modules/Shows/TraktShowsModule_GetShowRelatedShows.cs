namespace TraktNet.Modules
{
    ...
    public partial class TraktShowsModule : ATraktModule
    {
        ...
        /// <para>
        /// See <a href="https://docs.trakt.tv/reference/getshowsrelated">"Trakt API Doc - Shows: Related"</a> for more information.
        /// </para>
        /// </summary>
        ...
        public Task<TraktPagedResponse<ITraktShow>> GetShowRelatedShowsAsync(uint traktShowID, TraktExtendedInfo extendedInfo = null,
                                                                             TraktPagedParameters pagedParameters = null,
                                                                             CancellationToken cancellationToken = default)
        {
            if (traktShowID == 0)
            ...
            return GetShowRelatedShowsAsync(traktShowID.ToString(), extendedInfo, pagedParameters, cancellationToken);
        }
        ...
        public Task<TraktPagedResponse<ITraktShow>> GetShowRelatedShowsAsync(ITraktShowIds showIds, TraktExtendedInfo extendedInfo = null,
                                                                             TraktPagedParameters pagedParameters = null,
                                                                             CancellationToken cancellationToken = default)
        {
            if (showIds == null)
            ...
            return GetShowRelatedShowsAsync(showIds.GetBestId(), extendedInfo, pagedParameters, cancellationToken);
        }
        ...
        public Task<TraktPagedResponse<ITraktShow>> GetShowRelatedShowsAsync(ITraktShow show, TraktExtendedInfo extendedInfo = null,
                                                                             TraktPagedParameters pagedParameters = null,
                                                                             CancellationToken cancellationToken = default)
        {
            if (show == null)
            ...
            return GetShowRelatedShowsAsync(show.Ids, extendedInfo, pagedParameters, cancellationToken);
        }
    }
}
