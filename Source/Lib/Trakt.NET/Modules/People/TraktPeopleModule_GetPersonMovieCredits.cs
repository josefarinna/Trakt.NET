namespace TraktNet.Modules
{
    ...
    public partial class TraktPeopleModule : ATraktModule
    {
        ...
        /// <para>
        /// See <a href="https://docs.trakt.tv/reference/getpeoplesummary/summary/get-movie-credits">"Trakt API Doc - People: Movies"</a> for more information.
        /// </para>
        /// </summary>
        ...
        public Task<TraktResponse<ITraktPersonMovieCredits>> GetPersonMovieCreditsAsync(ITraktPerson person, TraktExtendedInfo extendedInfo = null,
                                                                                        CancellationToken cancellationToken = default)
        {
            if (person == null)
