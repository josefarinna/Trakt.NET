namespace TraktNet.Modules
{
    ...
    public partial class TraktPeopleModule : ATraktModule
    {
        ...
        public Task<TraktPagedResponse<ITraktList>> GetPersonListsAsync(ITraktPerson person, TraktListType listType = null,
                                                                        TraktListSortOrder listSortOrder = null,
                                                                        TraktExtendedInfo extendedInfo = null,
                                                                        TraktPagedParameters pagedParameters = null,
                                                                        CancellationToken cancellationToken = default)
        {
            ...
            return GetPersonListsAsync(person.Ids, listType, listSortOrder, extendedInfo, pagedParameters, cancellationToken);
        }
    }
}
