namespace TraktNet.Modules
{
    ...
    public partial class TraktPeopleModule : ATraktModule
    {
        ...
        /// <para>
        /// See <a href="https://docs.trakt.tv/reference/getpeopleshows">"Trakt API Doc - People: Shows"</a> for more information.
        /// </para>
        /// </summary>
        ...
        public Task<TraktResponse<ITraktPersonShowCredits>> GetPersonShowCreditsAsync(ITraktPerson person, TraktExtendedInfo extendedInfo = null,
                                                                                      CancellationToken cancellationToken = default)
        {
            if (person == null)
