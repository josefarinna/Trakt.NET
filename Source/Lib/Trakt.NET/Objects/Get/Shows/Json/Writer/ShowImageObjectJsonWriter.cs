namespace TraktNet.Objects.Get.Shows.Json.Writer
{
    ...
    internal class ShowImageObjectJsonWriter : AObjectJsonWriter<ITraktShowImage>
    {
        public override async Task WriteObjectAsync(JsonTextWriter jsonWriter, ITraktShowImage obj, CancellationToken cancellationToken = default)
        {
