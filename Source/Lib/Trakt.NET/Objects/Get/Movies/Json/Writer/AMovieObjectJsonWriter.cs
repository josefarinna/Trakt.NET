namespace TraktNet.Objects.Get.Movies.Json.Writer
{
    ...
    internal class AMovieObjectJsonWriter<TMovieObjectType> : AObjectJsonWriter<TMovieObjectType> where TMovieObjectType : ITraktMovie
    {
        public override async Task WriteObjectAsync(JsonTextWriter jsonWriter, TMovieObjectType obj, CancellationToken cancellationToken = default)
        {
            CheckJsonTextWriter(jsonWriter);
            await jsonWriter.WriteStartObjectAsync(cancellationToken).ConfigureAwait(false);
            await WriteMovieObjectAsync(jsonWriter, obj, cancellationToken).ConfigureAwait(false);
            await jsonWriter.WriteEndObjectAsync(cancellationToken).ConfigureAwait(false);
        }

        protected virtual async Task WriteMovieObjectAsync(JsonTextWriter jsonWriter, TMovieObjectType obj, CancellationToken cancellationToken = default)
        {
