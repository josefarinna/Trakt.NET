...
[Trakt.NET/docs/codesnippets/examples/modules/shows/TrendingShowsExample.cs](https://github.com/josefarinna/Trakt.NET/tree/v2.0.0-alpha.1/docs/codesnippets/examples/modules/shows/TrendingShowsExample.cs)

Trending Shows paged:
[Trakt.NET/docs/codesnippets/examples/modules/shows/TrendingShowsPagedExample.cs](https://github.com/josefarinna/Trakt.NET/tree/v2.0.0-alpha.1/docs/codesnippets/examples/modules/shows/TrendingShowsPagedExample.cs)
